...
import static com.particle.global.security.resourceserver.ResourceServerSecurityAutoConfiguration.scope_prefix;

/**
 * 参见第64行主要是添加空前缀，目前官方不能配置
...
public class SpringOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
	...
	private static final String AUTHORITY_PREFIX = scope_prefix;
