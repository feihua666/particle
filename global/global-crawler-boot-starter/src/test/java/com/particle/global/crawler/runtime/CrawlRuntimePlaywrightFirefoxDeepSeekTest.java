 ...
 */
public class CrawlRuntimePlaywrightFirefoxDeepSeekTest {
    ...
    public void testPlaywrightFirefoxCrawl() {
        ...
        browserConfig.getPlaywright().setUserDataDir(CrawlTestConstants.realFirefoxUserDataDir);
        browserConfig.getPlaywright().setUserDataDirProfile(CrawlTestConstants.realFirefoxUserDataDirProfile);
