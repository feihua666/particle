...
public enum ErrorCodeGlobalEnum implements IErrorCode {
	...
	/**
	 * 断言异常，主要用于使用 {@link com.particle.global.exception.Assert}时抛出的异常
	 */
	...
	REQUEST_CLIENT_NOT_IN_IP_WHITE_LIST_ERROR(40300000006L,"请求客户端不在ip白名单内"),
	REQUEST_CLIENT_IN_IP_BLACK_LIST_ERROR(40300000007L,"请求客户端在ip黑名单内"),
