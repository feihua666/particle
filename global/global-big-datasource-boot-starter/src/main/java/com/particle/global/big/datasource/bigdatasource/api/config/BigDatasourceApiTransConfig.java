 ...
 *
 * @author yangwei
 * @since 2024-01-07 14:33:36
 */
@Slf4j
@Data
public class BigDatasourceApiTransConfig {
	...
	public static BigDatasourceApiTransConfig create(List<TransItem> transItems) {
		BigDatasourceApiTransConfig config = new BigDatasourceApiTransConfig();
		config.transItems = transItems;
		return config;
	}
	 ...
	 * @param transItem
	 */
	public void addTransItem(TransItem transItem) {
