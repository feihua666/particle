 ...
 */
@Data
public class WorkflowExecuteUpToNodeCommand extends Command {
    ...
    @Schema(description = "运行到此节点为止（包含该节点）", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "数据来源执行ID（调试失败时，从此执行ID拷贝上下文和节点数据，以便断点续跑）")
