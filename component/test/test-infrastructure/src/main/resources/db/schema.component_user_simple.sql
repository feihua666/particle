DROP TABLE IF EXISTS component_user_simple;
CREATE TABLE `component_user_simple` (
  `id` bigint NOT NULL COMMENT '用户ID',
  `nickname` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '昵称，姓名,模糊查询',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=COMPACT COMMENT='简单用户表';
