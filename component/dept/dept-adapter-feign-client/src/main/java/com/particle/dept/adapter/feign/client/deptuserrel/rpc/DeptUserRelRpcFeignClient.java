 ...
 */
@FeignClient(name = "${particle.feign-client.dept.name:dept-start}", contextId = "deptUserRelRpcFeignClient", url = "${particle.feign-client.dept.url:}", path = "/rpc/dept_user_rel")
