-- 建表语句sql
DROP TABLE IF EXISTS component_dept_tree;
CREATE TABLE `component_dept_tree` (
  `id` bigint NOT NULL COMMENT '部门ID',
  `dept_id` bigint NOT NULL COMMENT '部门id',
  `dept_tree_name_id` bigint NOT NULL COMMENT '部门树id',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='部门树表';
