 ...
 */
@Tag(name = "意见反馈回复附件移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/feedback_reply_attachment")
public class FeedbackReplyAttachmentFrontMobileController extends AbstractBaseMobileAdapter {
