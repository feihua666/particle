 ...
 */
@Tag(name = "意见反馈附件移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/feedback_attachment")
public class FeedbackAttachmentAdminMobileController extends AbstractBaseMobileAdapter {
