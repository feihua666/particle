 ...
 */
@Tag(name = "意见反馈附件wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/feedback_attachment")
public class FeedbackAttachmentFrontWapController extends AbstractBaseWapAdapter {
