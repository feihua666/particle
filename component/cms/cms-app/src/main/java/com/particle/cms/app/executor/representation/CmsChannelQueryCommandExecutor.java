...
public class CmsChannelQueryCommandExecutor  extends AbstractBaseQueryExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<CmsChannelVO> executeDetail(CommonIdCommand detailCommand) {
     ...
     * @return
     */
    public MultiResponse<CmsChannelVO> execute(@Valid CommonBatchIdCommand commonBatchIdCommand) {
        List<CmsChannelDO> cmsChannelDO = iCmsChannelService.listByIds(commonBatchIdCommand.getIds());
        List<CmsChannelVO> cmsChannelVOs = CmsChannelAppStructMapping.instance.cmsChannelDOsToCmsChannelVOs(cmsChannelDO);
        return MultiResponse.of(cmsChannelVOs);
    }
	/**
	 ...
	 * @return
	 */
	public SingleResponse<CmsChannelVO> executeDetailForUpdate(CommonIdCommand detailForUpdateCommand) {
