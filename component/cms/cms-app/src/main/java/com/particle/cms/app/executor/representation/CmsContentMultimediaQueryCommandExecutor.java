...
public class CmsContentMultimediaQueryCommandExecutor  extends AbstractBaseQueryExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<CmsContentMultimediaVO> executeDetail(CommonIdCommand detailCommand) {
     ...
     * @return
     */
    public MultiResponse<CmsContentMultimediaVO> execute(@Valid CommonBatchIdCommand commonBatchIdCommand) {
        List<CmsContentMultimediaDO> cmsContentMultimediaDO = iCmsContentMultimediaService.listByIds(commonBatchIdCommand.getIds());
        List<CmsContentMultimediaVO> cmsContentMultimediaVOs = CmsContentMultimediaAppStructMapping.instance.cmsContentMultimediaDOsToCmsContentMultimediaVOs(cmsContentMultimediaDO);
        return MultiResponse.of(cmsContentMultimediaVOs);
    }
	/**
	 ...
	 * @return
	 */
	public SingleResponse<CmsContentMultimediaVO> executeDetailForUpdate(CommonIdCommand detailForUpdateCommand) {
