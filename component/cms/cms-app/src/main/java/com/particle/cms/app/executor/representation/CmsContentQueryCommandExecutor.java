...
public class CmsContentQueryCommandExecutor  extends AbstractBaseQueryExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<CmsContentVO> executeDetail(CommonIdCommand detailCommand) {
     ...
     * @return
     */
    public MultiResponse<CmsContentVO> execute(@Valid CommonBatchIdCommand commonBatchIdCommand) {
        List<CmsContentDO> cmsContentDO = iCmsContentService.listByIds(commonBatchIdCommand.getIds());
        List<CmsContentVO> cmsContentVOs = CmsContentAppStructMapping.instance.cmsContentDOsToCmsContentVOs(cmsContentDO);
        return MultiResponse.of(cmsContentVOs);
    }
	/**
	 ...
	 * @return
	 */
	public SingleResponse<CmsContentVO> executeDetailForUpdate(CommonIdCommand detailForUpdateCommand) {
