...
public interface ICmsSiteIndexViewRecordRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<CmsSiteIndexViewRecordVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<CmsSiteIndexViewRecordVO> queryDetail(CommonIdCommand detailCommand);
