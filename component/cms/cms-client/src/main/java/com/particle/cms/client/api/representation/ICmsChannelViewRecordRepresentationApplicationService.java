...
public interface ICmsChannelViewRecordRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<CmsChannelViewRecordVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<CmsChannelViewRecordVO> queryDetail(CommonIdCommand detailCommand);
