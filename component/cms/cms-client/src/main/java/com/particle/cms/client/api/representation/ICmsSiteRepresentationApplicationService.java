...
public interface ICmsSiteRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<CmsSiteVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<CmsSiteVO> queryDetail(CommonIdCommand detailCommand);
