...
public interface ICmsContentViewRecordRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<CmsContentViewRecordVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<CmsContentViewRecordVO> queryDetail(CommonIdCommand detailCommand);
