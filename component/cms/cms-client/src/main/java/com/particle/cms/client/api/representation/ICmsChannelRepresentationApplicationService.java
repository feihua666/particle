...
public interface ICmsChannelRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<CmsChannelVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<CmsChannelVO> queryDetail(CommonIdCommand detailCommand);
