 ...
 */
@Tag(name = "内容分类pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/cms_content_category")
public class CmsContentCategoryFrontWebController extends AbstractBaseWebAdapter {
