...
public class CmsChannelViewRecordAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<CmsChannelViewRecordVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<CmsChannelViewRecordVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<CmsChannelViewRecordVO> queryDetail(CommonIdCommand detailCommand){
