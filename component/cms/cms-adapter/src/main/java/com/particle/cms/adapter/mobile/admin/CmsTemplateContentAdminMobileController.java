 ...
 */
@Tag(name = "模板内容移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/cms_template_content")
public class CmsTemplateContentAdminMobileController extends AbstractBaseMobileAdapter {
