 ...
 */
@Tag(name = "内容访问记录移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/cms_content_view_record")
public class CmsContentViewRecordFrontMobileController extends AbstractBaseMobileAdapter {
