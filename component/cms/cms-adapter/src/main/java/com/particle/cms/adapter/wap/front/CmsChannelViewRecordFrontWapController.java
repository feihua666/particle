 ...
 */
@Tag(name = "栏目访问记录wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/cms_channel_view_record")
public class CmsChannelViewRecordFrontWapController extends AbstractBaseWapAdapter {
