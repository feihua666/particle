 ...
 */
@Tag(name = "内容分类wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/cms_content_category")
public class CmsContentCategoryAdminWapController extends AbstractBaseWapAdapter {
