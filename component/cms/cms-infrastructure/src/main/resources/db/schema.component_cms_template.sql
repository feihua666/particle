-- 建表语句sql
DROP TABLE IF EXISTS component_cms_template;
CREATE TABLE `component_cms_template` (
  `id` bigint NOT NULL COMMENT '主键ID',
  `template_key` varchar(500) NOT NULL COMMENT '唯一键',
  `name` varchar(100) NOT NULL COMMENT '文件名，目录名',
  `is_directory` tinyint(1) NOT NULL COMMENT '是否为目录，1=目录，0=文件',
  ...
  UNIQUE KEY `uni_template_key` (`template_key`) USING BTREE,
  UNIQUE KEY `uni_name_parent_id` (`name`,`parent_id`) USING BTREE,
