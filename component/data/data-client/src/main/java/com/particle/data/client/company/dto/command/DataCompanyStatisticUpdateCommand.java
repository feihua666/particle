...
public class DataCompanyStatisticUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyStatisticUpdateCommand createByWarehouseCommand(Long id, Integer version,DataCompanyStatisticWarehouseCommand dataCompanyStatisticWarehouseCommand){
        DataCompanyStatisticUpdateCommand command = new DataCompanyStatisticUpdateCommand();
        command.setId(id);
