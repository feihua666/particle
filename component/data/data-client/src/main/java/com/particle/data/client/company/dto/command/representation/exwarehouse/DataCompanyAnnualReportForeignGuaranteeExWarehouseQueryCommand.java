...
@Data
@Schema
public class DataCompanyAnnualReportForeignGuaranteeExWarehouseQueryCommand extends AbstractBasePageQueryCommand {
    ...
    public static DataCompanyAnnualReportForeignGuaranteeExWarehouseQueryCommand create(Long companyId,Long companyAnnualReportId) {
        DataCompanyAnnualReportForeignGuaranteeExWarehouseQueryCommand command = new DataCompanyAnnualReportForeignGuaranteeExWarehouseQueryCommand();
