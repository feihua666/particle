...
public interface IDataCompanyIprPatentLicenseRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentLicenseVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentLicenseVO> queryDetail(CommonIdCommand detailCommand);
