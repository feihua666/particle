...
@Data
@Schema
public class DataCompanyEquityPledgeCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyEquityPledgeCreateCommand createByWarehouseCommand(DataCompanyEquityPledgeWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyEquityPledgeCreateCommand command = new DataCompanyEquityPledgeCreateCommand();
