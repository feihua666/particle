...
@Data
@Schema
public class DataCompanyIprPatentCitedCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyIprPatentCitedCreateCommand createByWarehouseCommand(DataCompanyIprPatentCitedWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprPatentCitedCreateCommand command = new DataCompanyIprPatentCitedCreateCommand();
