...
@Data
@Schema
public class DataCompanyIprTrademarkPledgeExWarehouseQueryCommand extends AbstractBasePageQueryCommand {
    ...
    public static DataCompanyIprTrademarkPledgeExWarehouseQueryCommand create(Long companyIprTrademarkId) {
        DataCompanyIprTrademarkPledgeExWarehouseQueryCommand command = new DataCompanyIprTrademarkPledgeExWarehouseQueryCommand();
