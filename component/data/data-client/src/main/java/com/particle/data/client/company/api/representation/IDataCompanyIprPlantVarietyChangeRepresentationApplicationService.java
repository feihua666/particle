...
public interface IDataCompanyIprPlantVarietyChangeRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPlantVarietyChangeVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPlantVarietyChangeVO> queryDetail(CommonIdCommand detailCommand);
