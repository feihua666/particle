...
@Data
@Schema
public class DataCompanyJudgmentDocumentPartyUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyJudgmentDocumentPartyUpdateCommand createByWarehouseCommand(Long id, Integer version,DataCompanyJudgmentDocumentPartyWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyJudgmentDocumentPartyUpdateCommand command = new DataCompanyJudgmentDocumentPartyUpdateCommand();
        command.setId(id);
