...
@Data
@Schema
public class DataCompanyOpenCourtAnnouncementPartyCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyOpenCourtAnnouncementPartyCreateCommand createByWarehouseCommand(DataCompanyOpenCourtAnnouncementPartyWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyOpenCourtAnnouncementPartyCreateCommand command = new DataCompanyOpenCourtAnnouncementPartyCreateCommand();
