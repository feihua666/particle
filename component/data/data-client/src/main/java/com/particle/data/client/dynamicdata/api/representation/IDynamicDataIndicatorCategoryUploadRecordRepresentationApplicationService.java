...
public interface IDynamicDataIndicatorCategoryUploadRecordRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DynamicDataIndicatorCategoryUploadRecordVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DynamicDataIndicatorCategoryUploadRecordVO> queryDetail(CommonIdCommand detailCommand);
