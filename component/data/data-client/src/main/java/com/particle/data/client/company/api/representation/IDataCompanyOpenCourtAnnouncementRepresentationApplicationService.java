...
public interface IDataCompanyOpenCourtAnnouncementRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyOpenCourtAnnouncementVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyOpenCourtAnnouncementVO> queryDetail(CommonIdCommand detailCommand);
