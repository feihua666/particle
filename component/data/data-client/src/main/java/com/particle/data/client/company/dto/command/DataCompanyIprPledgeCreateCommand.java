...
@Data
@Schema
public class DataCompanyIprPledgeCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyIprPledgeCreateCommand createByWarehouseCommand(DataCompanyIprPledgeWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprPledgeCreateCommand command = new DataCompanyIprPledgeCreateCommand();
