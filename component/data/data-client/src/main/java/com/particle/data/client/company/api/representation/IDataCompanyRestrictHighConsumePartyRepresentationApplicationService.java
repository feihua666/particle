...
public interface IDataCompanyRestrictHighConsumePartyRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyRestrictHighConsumePartyVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyRestrictHighConsumePartyVO> queryDetail(CommonIdCommand detailCommand);
