...
public interface IDataCompanyAnnualReportWebsiteRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyAnnualReportWebsiteVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyAnnualReportWebsiteVO> queryDetail(CommonIdCommand detailCommand);
