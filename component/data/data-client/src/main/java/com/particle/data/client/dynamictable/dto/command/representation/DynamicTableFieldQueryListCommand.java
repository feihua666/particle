...
@Data
@Schema
public class DynamicTableFieldQueryListCommand extends AbstractBaseQueryCommand {
    ...
    /**
     * 如果{@link DynamicTableFieldQueryListCommand#dynamicTableId} 为空，则尝试使用该值对应的动态数据表格id
     */
