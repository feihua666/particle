...
public interface IDataCompanyPrimeStaffRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyPrimeStaffVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyPrimeStaffVO> queryDetail(CommonIdCommand detailCommand);
