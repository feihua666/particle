...
public interface IDataCompanyJudgmentDebtorRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyJudgmentDebtorVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyJudgmentDebtorVO> queryDetail(CommonIdCommand detailCommand);
