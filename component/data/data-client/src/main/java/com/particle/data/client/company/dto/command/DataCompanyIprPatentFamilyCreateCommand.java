...
@Data
@Schema
public class DataCompanyIprPatentFamilyCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyIprPatentFamilyCreateCommand createByWarehouseCommand(DataCompanyIprPatentFamilyWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprPatentFamilyCreateCommand command = new DataCompanyIprPatentFamilyCreateCommand();
