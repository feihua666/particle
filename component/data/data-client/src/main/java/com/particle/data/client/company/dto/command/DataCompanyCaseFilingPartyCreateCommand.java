...
@Data
@Schema
public class DataCompanyCaseFilingPartyCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyCaseFilingPartyCreateCommand createByWarehouseCommand(DataCompanyCaseFilingPartyWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyCaseFilingPartyCreateCommand command = new DataCompanyCaseFilingPartyCreateCommand();
