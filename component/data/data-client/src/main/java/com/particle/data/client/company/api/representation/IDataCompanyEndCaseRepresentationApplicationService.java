...
public interface IDataCompanyEndCaseRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyEndCaseVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyEndCaseVO> queryDetail(CommonIdCommand detailCommand);
