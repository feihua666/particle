...
@Data
@Schema
public class DataCompanyPrimeStaffUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyPrimeStaffUpdateCommand createByWarehouseCommand(Long id, Integer version,DataCompanyPrimeStaffWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyPrimeStaffUpdateCommand command = new DataCompanyPrimeStaffUpdateCommand();
        command.setId(id);
