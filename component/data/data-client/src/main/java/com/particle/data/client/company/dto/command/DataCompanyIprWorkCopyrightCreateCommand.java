...
@Data
@Schema
public class DataCompanyIprWorkCopyrightCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyIprWorkCopyrightCreateCommand createByWarehouseCommand(DataCompanyIprWorkCopyrightWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprWorkCopyrightCreateCommand command = new DataCompanyIprWorkCopyrightCreateCommand();
