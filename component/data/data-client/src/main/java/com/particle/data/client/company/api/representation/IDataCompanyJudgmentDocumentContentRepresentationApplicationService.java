...
public interface IDataCompanyJudgmentDocumentContentRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyJudgmentDocumentContentVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyJudgmentDocumentContentVO> queryDetail(CommonIdCommand detailCommand);
