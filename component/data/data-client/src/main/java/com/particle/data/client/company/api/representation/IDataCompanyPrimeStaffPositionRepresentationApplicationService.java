...
public interface IDataCompanyPrimeStaffPositionRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyPrimeStaffPositionVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyPrimeStaffPositionVO> queryDetail(CommonIdCommand detailCommand);
