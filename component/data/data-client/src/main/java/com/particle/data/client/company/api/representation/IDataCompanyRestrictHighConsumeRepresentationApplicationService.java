...
public interface IDataCompanyRestrictHighConsumeRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyRestrictHighConsumeVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyRestrictHighConsumeVO> queryDetail(CommonIdCommand detailCommand);
