...
@Data
@Schema
public class DataCompanyPunishmentExWarehouseVO extends AbstractBaseIdVO {
    ...
    @TransBy(type = TransConstants.TRANS_DICT_BY_ID,byFieldName = "fineAmountCurrencyDictId",mapValueField = "value")
    @Schema(description = "罚款金额币种对应字典值")
    private String fineAmountCurrencyDictValue;
    ...
    @TransBy(type = TransConstants.TRANS_DICT_BY_ID,byFieldName = "confiscateAmountCurrencyDictId",mapValueField = "value")
    @Schema(description = "没收金额币种对应字典值")
    private String confiscateAmountCurrencyDictValue;
