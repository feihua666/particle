...
@Data
@Schema
public class DataCompanyIprTrademarkTransferExWarehouseQueryCommand extends AbstractBasePageQueryCommand {
    ...
    public static DataCompanyIprTrademarkTransferExWarehouseQueryCommand create(Long companyIprTrademarkId) {
        DataCompanyIprTrademarkTransferExWarehouseQueryCommand command = new DataCompanyIprTrademarkTransferExWarehouseQueryCommand();
