...
public interface IDataCompanyIprTrademarkRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprTrademarkVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprTrademarkVO> queryDetail(CommonIdCommand detailCommand);
