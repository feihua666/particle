...
@Data
@Schema
public class DataCompanyAnnualReportShareholderExWarehouseQueryCommand extends AbstractBasePageQueryCommand {
    ...
    public static DataCompanyAnnualReportShareholderExWarehouseQueryCommand create(Long companyId,Long companyAnnualReportId) {
        DataCompanyAnnualReportShareholderExWarehouseQueryCommand command = new DataCompanyAnnualReportShareholderExWarehouseQueryCommand();
