...
public interface IDataCompanyVcInvestInstitutionRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyVcInvestInstitutionVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyVcInvestInstitutionVO> queryDetail(CommonIdCommand detailCommand);
