...
@Data
@Schema
public class DataCompanyAnnualReportWebsiteExWarehouseQueryCommand extends AbstractBasePageQueryCommand {
    ...
    public static DataCompanyAnnualReportWebsiteExWarehouseQueryCommand create(Long companyId,Long companyAnnualReportId) {
        DataCompanyAnnualReportWebsiteExWarehouseQueryCommand command = new DataCompanyAnnualReportWebsiteExWarehouseQueryCommand();
