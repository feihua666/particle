...
public interface IDataCompanyOpenCourtAnnouncementContentRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyOpenCourtAnnouncementContentVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyOpenCourtAnnouncementContentVO> queryDetail(CommonIdCommand detailCommand);
