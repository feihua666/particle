...
@Data
@Schema
public class DataCompanyIprPatentQuoteCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyIprPatentQuoteCreateCommand createByWarehouseCommand(DataCompanyIprPatentQuoteWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprPatentQuoteCreateCommand command = new DataCompanyIprPatentQuoteCreateCommand();
