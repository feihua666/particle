...
public interface IDataCompanyIprPatentCertificateRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentCertificateVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentCertificateVO> queryDetail(CommonIdCommand detailCommand);
