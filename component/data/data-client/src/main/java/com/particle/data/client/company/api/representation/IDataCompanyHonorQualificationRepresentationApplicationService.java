...
public interface IDataCompanyHonorQualificationRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyHonorQualificationVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyHonorQualificationVO> queryDetail(CommonIdCommand detailCommand);
