...
public interface IDataCompanyJudgmentDocumentRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyJudgmentDocumentVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyJudgmentDocumentVO> queryDetail(CommonIdCommand detailCommand);
