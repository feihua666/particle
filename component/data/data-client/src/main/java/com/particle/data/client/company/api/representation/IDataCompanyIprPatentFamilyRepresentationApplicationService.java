...
public interface IDataCompanyIprPatentFamilyRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentFamilyVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentFamilyVO> queryDetail(CommonIdCommand detailCommand);
