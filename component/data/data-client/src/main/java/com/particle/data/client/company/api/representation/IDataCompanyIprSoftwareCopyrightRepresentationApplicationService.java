...
public interface IDataCompanyIprSoftwareCopyrightRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprSoftwareCopyrightVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprSoftwareCopyrightVO> queryDetail(CommonIdCommand detailCommand);
