...
@Data
@Schema
public class DataCompanyAdministrativeLicenseUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyAdministrativeLicenseUpdateCommand createByWarehouseCommand(Long id, Integer version,DataCompanyAdministrativeLicenseWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyAdministrativeLicenseUpdateCommand command = new DataCompanyAdministrativeLicenseUpdateCommand();
        command.setId(id);
