...
public interface IDataCompanyIprPatentPartyRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentPartyVO> queryDetailForUpdate(IdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentPartyVO> queryDetail(IdCommand detailCommand);
