 ...
 * @since 2023-01-03
 */
public interface IDataCompanyIprPatentPartyRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentPartyVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentPartyVO> queryDetail(CommonIdCommand detailCommand);
	 ...
	 * @return
	 */
	MultiResponse<DataCompanyIprPatentPartyVO> queryList(DataCompanyIprPatentPartyQueryListCommand dataCompanyIprPatentPartyQueryListCommand);
	 ...
	 * @return
	 */
	PageResponse<DataCompanyIprPatentPartyVO> pageQuery(DataCompanyIprPatentPartyPageQueryCommand dataCompanyIprPatentPartyPageQueryCommand);
