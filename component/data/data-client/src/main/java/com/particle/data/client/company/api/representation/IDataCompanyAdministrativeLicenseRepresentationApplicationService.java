...
public interface IDataCompanyAdministrativeLicenseRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyAdministrativeLicenseVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyAdministrativeLicenseVO> queryDetail(CommonIdCommand detailCommand);
