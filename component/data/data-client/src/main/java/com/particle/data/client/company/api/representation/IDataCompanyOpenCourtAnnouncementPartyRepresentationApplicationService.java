...
public interface IDataCompanyOpenCourtAnnouncementPartyRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyOpenCourtAnnouncementPartyVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyOpenCourtAnnouncementPartyVO> queryDetail(CommonIdCommand detailCommand);
