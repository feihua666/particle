...
public interface IDynamicDataIndicatorRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DynamicDataIndicatorVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DynamicDataIndicatorVO> queryDetail(CommonIdCommand detailCommand);
