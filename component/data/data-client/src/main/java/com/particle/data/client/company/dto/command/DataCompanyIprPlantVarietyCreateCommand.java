...
@Data
@Schema
public class DataCompanyIprPlantVarietyCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyIprPlantVarietyCreateCommand createByWarehouseCommand(DataCompanyIprPlantVarietyWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprPlantVarietyCreateCommand command = new DataCompanyIprPlantVarietyCreateCommand();
