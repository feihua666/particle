...
@Data
@Schema
public class DataCompanyEndCaseCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyEndCaseCreateCommand createByWarehouseCommand(DataCompanyEndCaseWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyEndCaseCreateCommand command = new DataCompanyEndCaseCreateCommand();
