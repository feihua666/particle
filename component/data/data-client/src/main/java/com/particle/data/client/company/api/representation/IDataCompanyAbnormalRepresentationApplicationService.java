...
public interface IDataCompanyAbnormalRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyAbnormalVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyAbnormalVO> queryDetail(CommonIdCommand detailCommand);
