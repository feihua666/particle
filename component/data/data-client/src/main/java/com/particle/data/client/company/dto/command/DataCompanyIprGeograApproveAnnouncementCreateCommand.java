...
@Data
@Schema
public class DataCompanyIprGeograApproveAnnouncementCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyIprGeograApproveAnnouncementCreateCommand createByWarehouseCommand(DataCompanyIprGeograApproveAnnouncementWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprGeograApproveAnnouncementCreateCommand command = new DataCompanyIprGeograApproveAnnouncementCreateCommand();
