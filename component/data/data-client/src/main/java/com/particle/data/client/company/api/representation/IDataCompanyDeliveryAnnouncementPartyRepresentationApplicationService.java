...
public interface IDataCompanyDeliveryAnnouncementPartyRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyDeliveryAnnouncementPartyVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyDeliveryAnnouncementPartyVO> queryDetail(CommonIdCommand detailCommand);
