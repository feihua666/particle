...
@Data
@Schema
public class DataCompanyIprTrademarkCreateCommand extends AbstractBaseCommand {
    ...
    @NotEmpty(message = "注册号 不能为空")
    @Schema(description = "注册号",requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    public static DataCompanyIprTrademarkCreateCommand createByWarehouseCommand(DataCompanyIprTrademarkWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprTrademarkCreateCommand command = new DataCompanyIprTrademarkCreateCommand();
