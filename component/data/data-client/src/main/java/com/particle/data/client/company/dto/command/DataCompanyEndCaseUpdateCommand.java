...
@Data
@Schema
public class DataCompanyEndCaseUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyEndCaseUpdateCommand createByWarehouseCommand(Long id, Integer version,DataCompanyEndCaseWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyEndCaseUpdateCommand command = new DataCompanyEndCaseUpdateCommand();
        command.setId(id);
