...
@Data
@Schema
public class DataCompanyIprIntegratedCircuitCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyIprIntegratedCircuitCreateCommand createByWarehouseCommand(DataCompanyIprIntegratedCircuitWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprIntegratedCircuitCreateCommand command = new DataCompanyIprIntegratedCircuitCreateCommand();
