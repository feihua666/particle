...
@Data
@Schema
public class DataCompanyEquityPledgeExWarehouseQueryCommand extends AbstractBasePageQueryCommand {
    ...
    public static DataCompanyEquityPledgeExWarehouseQueryCommand create(Long companyId) {
        DataCompanyEquityPledgeExWarehouseQueryCommand command = new DataCompanyEquityPledgeExWarehouseQueryCommand();
