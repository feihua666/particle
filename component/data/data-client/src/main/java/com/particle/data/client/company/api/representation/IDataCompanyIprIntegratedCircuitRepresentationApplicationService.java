...
public interface IDataCompanyIprIntegratedCircuitRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprIntegratedCircuitVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprIntegratedCircuitVO> queryDetail(CommonIdCommand detailCommand);
