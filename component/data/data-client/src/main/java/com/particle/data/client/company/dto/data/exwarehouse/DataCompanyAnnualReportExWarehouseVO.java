...
@Data
@Schema
public class DataCompanyAnnualReportExWarehouseVO extends AbstractBaseIdVO {
    ...
    @TransBy(type = TransConstants.TRANS_DICT_BY_ID,byFieldName = "capitalCurrencyDictId",mapValueField = "value")
    @Schema(description = "资金数额币种对应字典值")
    private String capitalCurrencyDictValue;
    ...
    @Schema(description = "企业经营状态对应字典值")
