...
public interface IDataCompanySeriousIllegalRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanySeriousIllegalVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanySeriousIllegalVO> queryDetail(CommonIdCommand detailCommand);
