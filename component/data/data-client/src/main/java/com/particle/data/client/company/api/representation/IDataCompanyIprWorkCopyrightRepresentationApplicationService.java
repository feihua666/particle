...
public interface IDataCompanyIprWorkCopyrightRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprWorkCopyrightVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprWorkCopyrightVO> queryDetail(CommonIdCommand detailCommand);
