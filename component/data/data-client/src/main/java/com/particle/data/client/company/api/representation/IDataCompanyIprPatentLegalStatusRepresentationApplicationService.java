...
public interface IDataCompanyIprPatentLegalStatusRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentLegalStatusVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentLegalStatusVO> queryDetail(CommonIdCommand detailCommand);
