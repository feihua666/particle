...
public interface IDataCompanyIprTrademarkLicensePersonRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprTrademarkLicensePersonVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprTrademarkLicensePersonVO> queryDetail(CommonIdCommand detailCommand);
