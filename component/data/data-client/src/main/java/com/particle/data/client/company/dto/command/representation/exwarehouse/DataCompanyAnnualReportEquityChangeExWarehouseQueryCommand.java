...
@Data
@Schema
public class DataCompanyAnnualReportEquityChangeExWarehouseQueryCommand extends AbstractBasePageQueryCommand {
    ...
    public static DataCompanyAnnualReportEquityChangeExWarehouseQueryCommand create(Long companyId,Long companyAnnualReportId) {
        DataCompanyAnnualReportEquityChangeExWarehouseQueryCommand command = new DataCompanyAnnualReportEquityChangeExWarehouseQueryCommand();
