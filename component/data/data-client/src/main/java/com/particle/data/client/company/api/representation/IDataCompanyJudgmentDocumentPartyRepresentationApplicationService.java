...
public interface IDataCompanyJudgmentDocumentPartyRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyJudgmentDocumentPartyVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyJudgmentDocumentPartyVO> queryDetail(CommonIdCommand detailCommand);
