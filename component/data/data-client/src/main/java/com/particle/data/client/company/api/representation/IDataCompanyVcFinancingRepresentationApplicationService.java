...
public interface IDataCompanyVcFinancingRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyVcFinancingVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyVcFinancingVO> queryDetail(CommonIdCommand detailCommand);
