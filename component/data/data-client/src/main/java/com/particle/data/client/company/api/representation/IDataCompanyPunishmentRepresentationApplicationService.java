...
public interface IDataCompanyPunishmentRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyPunishmentVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyPunishmentVO> queryDetail(CommonIdCommand detailCommand);
