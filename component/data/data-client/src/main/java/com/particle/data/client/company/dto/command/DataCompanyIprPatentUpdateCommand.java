...
public class DataCompanyIprPatentUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyIprPatentUpdateCommand createByWarehouseCommand(Long id, Integer version,DataCompanyIprPatentWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprPatentUpdateCommand command = new DataCompanyIprPatentUpdateCommand();
        command.setId(id);
