...
public interface IDataCompanyAnnualReportForeignGuaranteeRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyAnnualReportForeignGuaranteeVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyAnnualReportForeignGuaranteeVO> queryDetail(CommonIdCommand detailCommand);
