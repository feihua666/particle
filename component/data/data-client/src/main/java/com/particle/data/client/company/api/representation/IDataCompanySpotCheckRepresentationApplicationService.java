...
public interface IDataCompanySpotCheckRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanySpotCheckVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanySpotCheckVO> queryDetail(CommonIdCommand detailCommand);
