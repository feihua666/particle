...
@Data
@Schema
public class DataCompanySpotCheckCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanySpotCheckCreateCommand createByWarehouseCommand(DataCompanySpotCheckWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanySpotCheckCreateCommand command = new DataCompanySpotCheckCreateCommand();
