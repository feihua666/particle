...
public interface IDataCompanyAnnualReportForeignInvestRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyAnnualReportForeignInvestVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyAnnualReportForeignInvestVO> queryDetail(CommonIdCommand detailCommand);
