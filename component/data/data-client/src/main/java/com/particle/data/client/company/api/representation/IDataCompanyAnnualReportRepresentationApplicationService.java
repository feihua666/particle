...
public interface IDataCompanyAnnualReportRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyAnnualReportVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyAnnualReportVO> queryDetail(CommonIdCommand detailCommand);
