...
@Data
@Schema
public class DataCompanyAnnualReportUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyAnnualReportUpdateCommand createByWarehouseCommand(Long id, Integer version, DataCompanyAnnualReportWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyAnnualReportUpdateCommand command = new DataCompanyAnnualReportUpdateCommand();
        command.setId(id);
