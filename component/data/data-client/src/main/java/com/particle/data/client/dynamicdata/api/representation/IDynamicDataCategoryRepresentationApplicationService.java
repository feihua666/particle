...
public interface IDynamicDataCategoryRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DynamicDataCategoryVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DynamicDataCategoryVO> queryDetail(CommonIdCommand detailCommand);
