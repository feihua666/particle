...
@Data
@Schema
public class DataCompanyIprTrademarkPartyUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyIprTrademarkPartyUpdateCommand createByWarehouseCommand(Long id, Integer version,DataCompanyIprTrademarkPartyWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprTrademarkPartyUpdateCommand command = new DataCompanyIprTrademarkPartyUpdateCommand();
        command.setId(id);
