...
@Data
@Schema
public class DataCompanyPersonCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyPersonCreateCommand createByWarehouseCommand(DataCompanyPersonWarehouseCommand dataCompanyPersonWarehouseCommand){
        DataCompanyPersonCreateCommand command = new DataCompanyPersonCreateCommand();
