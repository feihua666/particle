...
public interface IDataCompanyIprPatentQuoteRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentQuoteVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentQuoteVO> queryDetail(CommonIdCommand detailCommand);
