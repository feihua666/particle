...
public interface IDataCompanyIprPlantVarietyRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPlantVarietyVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPlantVarietyVO> queryDetail(CommonIdCommand detailCommand);
