...
@Data
@Schema
public class DataCompanyCourtAnnouncementPartyUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyCourtAnnouncementPartyUpdateCommand createByWarehouseCommand(Long id, Integer version,DataCompanyCourtAnnouncementPartyWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyCourtAnnouncementPartyUpdateCommand command = new DataCompanyCourtAnnouncementPartyUpdateCommand();
        command.setId(id);
