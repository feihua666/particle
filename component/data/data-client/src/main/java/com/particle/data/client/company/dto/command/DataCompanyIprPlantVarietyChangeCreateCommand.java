...
@Data
@Schema
public class DataCompanyIprPlantVarietyChangeCreateCommand extends AbstractBaseCommand {
    ...
    public static DataCompanyIprPlantVarietyChangeCreateCommand createByWarehouseCommand(DataCompanyIprPlantVarietyChangeWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprPlantVarietyChangeCreateCommand command = new DataCompanyIprPlantVarietyChangeCreateCommand();
