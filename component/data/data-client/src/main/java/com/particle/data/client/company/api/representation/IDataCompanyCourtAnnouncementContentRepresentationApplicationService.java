...
public interface IDataCompanyCourtAnnouncementContentRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyCourtAnnouncementContentVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyCourtAnnouncementContentVO> queryDetail(CommonIdCommand detailCommand);
