...
public interface IDataCompanyIprTrademarkPledgeRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprTrademarkPledgeVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprTrademarkPledgeVO> queryDetail(CommonIdCommand detailCommand);
