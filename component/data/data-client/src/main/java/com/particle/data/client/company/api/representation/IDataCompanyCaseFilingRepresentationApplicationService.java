...
public interface IDataCompanyCaseFilingRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyCaseFilingVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyCaseFilingVO> queryDetail(CommonIdCommand detailCommand);
