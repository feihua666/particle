...
@Data
@Schema
public class DataCompanyIprPatentQuoteWarehouseCommand extends AbstractBaseCommand {
    ...
    public boolean allFieldEmpty() {
        return Objects.isNull(companyIprPatentId)
                ...
                && StrUtil.isEmpty(applicantQuoteNo)
                && StrUtil.isEmpty(examinerQuoteNo);
    }
     ...
     * @param exWarehouseVO
     */
    public void compareAndSetNullWhenEquals(DataCompanyIprPatentQuoteExWarehouseVO exWarehouseVO) {
        ...
        if (Objects.equals(applicantQuoteNo, exWarehouseVO.getApplicantQuoteNo())) {
            this.applicantQuoteNo = null;
        }
        if (Objects.equals(examinerQuoteNo, exWarehouseVO.getExaminerQuoteNo())) {
            this.examinerQuoteNo = null;
        }

    }
    public static DataCompanyIprPatentQuoteWarehouseCommand createByDataCompanyIprPatentQuoteExWarehouseVO(DataCompanyIprPatentQuoteExWarehouseVO exWarehouseVO) {
        DataCompanyIprPatentQuoteWarehouseCommand command = new DataCompanyIprPatentQuoteWarehouseCommand();
        ...
        command.applicantQuoteNo = exWarehouseVO.getApplicantQuoteNo();
        command.examinerQuoteNo = exWarehouseVO.getExaminerQuoteNo();
