...
@Data
@Schema
public class DataCompanyAnnualReportSocialSecurityExWarehouseQueryCommand extends AbstractBasePageQueryCommand {
    ...
    public static DataCompanyAnnualReportSocialSecurityExWarehouseQueryCommand create(Long companyId,Long companyAnnualReportId) {
        DataCompanyAnnualReportSocialSecurityExWarehouseQueryCommand command = new DataCompanyAnnualReportSocialSecurityExWarehouseQueryCommand();
