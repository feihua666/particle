...
public interface IDataCompanyIprPatentNoticeRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentNoticeVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentNoticeVO> queryDetail(CommonIdCommand detailCommand);
