...
@Data
@Schema
public class DataCompanyAnnualReportForeignInvestExWarehouseQueryCommand extends AbstractBasePageQueryCommand {
    ...
    public static DataCompanyAnnualReportForeignInvestExWarehouseQueryCommand create(Long companyId,Long companyAnnualReportId) {
        DataCompanyAnnualReportForeignInvestExWarehouseQueryCommand command = new DataCompanyAnnualReportForeignInvestExWarehouseQueryCommand();
