...
@Data
@Schema
public class DataCompanyIprSoftwareCopyrightUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyIprSoftwareCopyrightUpdateCommand createByWarehouseCommand(Long id, Integer version,DataCompanyIprSoftwareCopyrightWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprSoftwareCopyrightUpdateCommand command = new DataCompanyIprSoftwareCopyrightUpdateCommand();
        command.setId(id);
