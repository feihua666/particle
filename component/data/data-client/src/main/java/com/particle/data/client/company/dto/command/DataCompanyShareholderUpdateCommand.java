...
@Data
@Schema
public class DataCompanyShareholderUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyShareholderUpdateCommand createByWarehouseCommand(Long id, Integer version, DataCompanyShareholderWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyShareholderUpdateCommand command = new DataCompanyShareholderUpdateCommand();
        command.setId(id);
