...
public interface IDataCompanyIprPatentStatisticRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentStatisticVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprPatentStatisticVO> queryDetail(CommonIdCommand detailCommand);
