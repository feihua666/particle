...
@Data
@Schema
public class DataCompanyIprGeograUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyIprGeograUpdateCommand createByWarehouseCommand(Long id, Integer version,DataCompanyIprGeograWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyIprGeograUpdateCommand command = new DataCompanyIprGeograUpdateCommand();
        command.setId(id);
