...
public interface IDataCompanyCourtAnnouncementRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyCourtAnnouncementVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyCourtAnnouncementVO> queryDetail(CommonIdCommand detailCommand);
