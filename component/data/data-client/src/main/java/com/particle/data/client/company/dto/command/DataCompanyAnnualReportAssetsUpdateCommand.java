...
@Data
@Schema
public class DataCompanyAnnualReportAssetsUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyAnnualReportAssetsUpdateCommand createByWarehouseCommand(Long id, Integer version,DataCompanyAnnualReportAssetsWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyAnnualReportAssetsUpdateCommand command = new DataCompanyAnnualReportAssetsUpdateCommand();
        command.setId(id);
