...
@Data
@Schema
public class DataCompanyVcFinancingExWarehouseVO extends AbstractBaseIdVO {
    ...
    @Schema(description = "融资机构")
    private List<DataCompanyVcInvestInstitutionExWarehouseVO> vcInvestInstitutions;
