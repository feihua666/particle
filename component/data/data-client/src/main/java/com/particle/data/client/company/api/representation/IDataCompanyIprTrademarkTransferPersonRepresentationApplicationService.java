...
public interface IDataCompanyIprTrademarkTransferPersonRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprTrademarkTransferPersonVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprTrademarkTransferPersonVO> queryDetail(CommonIdCommand detailCommand);
