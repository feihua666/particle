...
@Data
@Schema
public class DataCompanySpotCheckExWarehouseQueryCommand extends AbstractBasePageQueryCommand {
    ...
    public static DataCompanySpotCheckExWarehouseQueryCommand create(Long companyId) {
        DataCompanySpotCheckExWarehouseQueryCommand command = new DataCompanySpotCheckExWarehouseQueryCommand();
