...
@Data
@Schema
public class DataCompanyIprPledgeExWarehouseQueryCommand extends AbstractBasePageQueryCommand {
    ...
    public static DataCompanyIprPledgeExWarehouseQueryCommand create(Long companyId) {
        DataCompanyIprPledgeExWarehouseQueryCommand command = new DataCompanyIprPledgeExWarehouseQueryCommand();
