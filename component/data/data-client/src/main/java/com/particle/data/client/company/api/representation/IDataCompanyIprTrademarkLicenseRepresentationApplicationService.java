...
public interface IDataCompanyIprTrademarkLicenseRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprTrademarkLicenseVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyIprTrademarkLicenseVO> queryDetail(CommonIdCommand detailCommand);
