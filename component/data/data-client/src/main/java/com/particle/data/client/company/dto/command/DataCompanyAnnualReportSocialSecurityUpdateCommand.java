...
@Data
@Schema
public class DataCompanyAnnualReportSocialSecurityUpdateCommand extends AbstractBaseUpdateCommand {
    ...
    public static DataCompanyAnnualReportSocialSecurityUpdateCommand createByWarehouseCommand(Long id, Integer version,DataCompanyAnnualReportSocialSecurityWarehouseCommand dataCompanyBasicWarehouseCommand){
        DataCompanyAnnualReportSocialSecurityUpdateCommand command = new DataCompanyAnnualReportSocialSecurityUpdateCommand();
        command.setId(id);
