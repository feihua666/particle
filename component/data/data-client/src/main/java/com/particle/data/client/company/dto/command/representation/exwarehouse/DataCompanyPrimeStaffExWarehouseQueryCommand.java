...
@Data
@Schema
public class DataCompanyPrimeStaffExWarehouseQueryCommand extends AbstractBasePageQueryCommand {
    ...
    public static DataCompanyPrimeStaffExWarehouseQueryCommand create(Long companyId) {
        DataCompanyPrimeStaffExWarehouseQueryCommand command = new DataCompanyPrimeStaffExWarehouseQueryCommand();
