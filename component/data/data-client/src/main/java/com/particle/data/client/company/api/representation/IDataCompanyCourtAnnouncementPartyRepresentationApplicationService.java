...
public interface IDataCompanyCourtAnnouncementPartyRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyCourtAnnouncementPartyVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataCompanyCourtAnnouncementPartyVO> queryDetail(CommonIdCommand detailCommand);
