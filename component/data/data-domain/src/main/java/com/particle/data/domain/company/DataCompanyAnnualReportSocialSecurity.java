...
@Data
@Entity
public class DataCompanyAnnualReportSocialSecurity extends AggreateRoot {

    private DataCompanyAnnualReportSocialSecurityId id;
    ...
    */
    ...
    /**
     * 创建企业年报社保领域模型对象
     * @return 企业年报社保领域模型对象，该对应所有属性为空，需要进行初始化操作
     */
    public static DataCompanyAnnualReportSocialSecurity create(){
        return DomainFactory.create(DataCompanyAnnualReportSocialSecurity.class);
    }
}
