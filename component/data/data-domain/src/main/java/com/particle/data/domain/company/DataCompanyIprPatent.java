...
@Data
@Entity
public class DataCompanyIprPatent extends AggreateRoot {

    private DataCompanyIprPatentId id;
    ...
    */
    ...
    /**
     * 创建企业知识产权专利领域模型对象
     * @return 企业知识产权专利领域模型对象，该对应所有属性为空，需要进行初始化操作
     */
    public static DataCompanyIprPatent create(){
        return DomainFactory.create(DataCompanyIprPatent.class);
    }
}