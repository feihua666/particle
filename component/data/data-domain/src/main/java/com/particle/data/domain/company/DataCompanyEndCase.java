...
@Data
@Entity
public class DataCompanyEndCase extends AggreateRoot {

    private DataCompanyEndCaseId id;
    ...
    */
    ...
    public void initDataMd5() {
        this.dataMd5 = SomeMd5Tool.dataCompanyEndCaseDataMd5(caseNo, executedPersonName, fileCaseDate);
    }

    /**
     * 创建企业终本案件领域模型对象
     * @return 企业终本案件领域模型对象，该对应所有属性为空，需要进行初始化操作
     */
    public static DataCompanyEndCase create(){
        return DomainFactory.create(DataCompanyEndCase.class);
    }
}
