-- 建表语句sql
DROP TABLE IF EXISTS component_data_company_ipr_patent_quote;
CREATE TABLE `component_data_company_ipr_patent_quote` (
  ...
  `applicant_quote_no` varchar(50) DEFAULT NULL COMMENT '申请人引证标准号',
  `examiner_quote_no` varchar(50) DEFAULT NULL COMMENT '审查员引证标准号',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='企业知识产权专利引证信息表';
