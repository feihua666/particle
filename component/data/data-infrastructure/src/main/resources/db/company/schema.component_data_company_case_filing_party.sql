-- 建表语句sql
DROP TABLE IF EXISTS component_data_company_case_filing_party;
CREATE TABLE `component_data_company_case_filing_party` (
  `id` bigint NOT NULL COMMENT '主键ID',
  `company_case_filing_id` bigint DEFAULT NULL COMMENT '立案信息表id',
  ...
  UNIQUE KEY `uni_company_case_filing_id__data_md5` (`company_case_filing_id`,`data_md5`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='企业立案信息当事人表';
