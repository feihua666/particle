-- 建表语句sql
DROP TABLE IF EXISTS component_data_company_court_announcement_party;
CREATE TABLE `component_data_company_court_announcement_party` (
  ...
  UNIQUE KEY `uni_company_court_announcement_id__data_md5` (`company_court_announcement_id`,`data_md5`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='企业法院公告当事人表';
