...
CREATE TABLE `component_data_company_ipr_patent_transfer` (
  ...
  `current__address` varchar(100) DEFAULT NULL COMMENT '当前地址',
  `change_effective_date` date DEFAULT NULL COMMENT '变更生效日期',
  `data_md5` varchar(32) DEFAULT NULL COMMENT '数据md5,transfer_type + dept + change_before_right_holder + change_after_right_holder + current_right_holder',
