...
CREATE TABLE `component_data_company_honor_qualification` (
  ...
  `grade` varchar(100) DEFAULT NULL COMMENT '等级，如：国家级',
  ...
  `data_md5` varchar(32) NOT NULL COMMENT '数据md5,name + grade + certificate_no + publish_office + publish_title',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='企业荣誉资质表';
