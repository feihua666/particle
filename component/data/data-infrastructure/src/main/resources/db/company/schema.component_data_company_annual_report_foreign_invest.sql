...
CREATE TABLE `component_data_company_annual_report_foreign_invest` (
  ...
  `invest_company_reg_no` varchar(100) DEFAULT NULL COMMENT '对外投资企业注册号',
  ...
  `data_md5` varchar(32) NOT NULL COMMENT '数据md5,invest_company_name',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='企业年报对外投资表';
