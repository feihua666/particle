...
CREATE TABLE `component_data_company_ipr_patent_notice` (
  ...
  `data_md5` varchar(32) NOT NULL COMMENT '数据md5,public_date + mail_no + receiver_name + notice_type + notice_type_description',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='企业知识产权专利通知书信息表';
