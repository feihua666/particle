-- 建表语句sql
DROP TABLE IF EXISTS component_data_company_delivery_announcement_party;
CREATE TABLE `component_data_company_delivery_announcement_party` (
  `id` bigint NOT NULL COMMENT '主键ID',
  `company_delivery_announcement_id` bigint DEFAULT NULL COMMENT '送达公告表id',
  `party_name` varchar(100) DEFAULT NULL COMMENT '当事人名称',
  `is_party_natural_person` tinyint(1) DEFAULT NULL COMMENT '是否法人为自然人，1=自然人，0=非自然人',
  ...
  UNIQUE KEY `uni_company_delivery_announcement_id__data_md5` (`company_delivery_announcement_id`,`data_md5`) USING BTREE,
  KEY `party_company_id` (`party_company_id`) USING BTREE,
  KEY `party_company_person_id` (`party_company_person_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='企业送达公告当事人表';
