-- 建表语句sql
DROP TABLE IF EXISTS component_data_company_ipr_work_copyright;
CREATE TABLE `component_data_company_ipr_work_copyright` (
  `id` bigint NOT NULL COMMENT '主键ID',
  `reg_no` varchar(50) DEFAULT NULL COMMENT '注册号,登记号',
  `name` varchar(100) DEFAULT NULL COMMENT '作品名称',
  `type_name` varchar(100) DEFAULT NULL COMMENT '作品类别，如：美术',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='企业知识产权作品著作表';
