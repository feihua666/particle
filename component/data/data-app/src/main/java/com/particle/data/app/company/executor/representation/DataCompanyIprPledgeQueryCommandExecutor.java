...
public class DataCompanyIprPledgeQueryCommandExecutor  extends AbstractBaseQueryExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<DataCompanyIprPledgeVO> executeDetail(CommonIdCommand detailCommand) {
	 ...
	 * @return
	 */
	public SingleResponse<DataCompanyIprPledgeVO> executeDetailForUpdate(CommonIdCommand detailForUpdateCommand) {
