...
public class DataCompanyPrimeStaffPositionQueryCommandExecutor  extends AbstractBaseQueryExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<DataCompanyPrimeStaffPositionVO> executeDetail(CommonIdCommand detailCommand) {
	 ...
	 * @return
	 */
	public SingleResponse<DataCompanyPrimeStaffPositionVO> executeDetailForUpdate(CommonIdCommand detailForUpdateCommand) {
