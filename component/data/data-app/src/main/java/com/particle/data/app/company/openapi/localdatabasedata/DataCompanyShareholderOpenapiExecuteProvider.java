...
public class DataCompanyShareholderOpenapiExecuteProvider extends AbstractDataCompanyOpenapiExecuteProvider {
    ...
    public void warehouse(OpenapiWarehouseCommand warehouseCommand,OpenapiCommand openapiCommand,  OpenapiContext openapiContext) {
        PageResponse<DataCompanyShareholderExWarehouseVO> dataCompanyShareholderExWarehouseVOPageResponse = (PageResponse<DataCompanyShareholderExWarehouseVO>) warehouseCommand.getParam();
        dataCompanyShareholderWrapWarehouseCommandExecutor.warehouse(dataCompanyShareholderExWarehouseVOPageResponse);
    }
