 ...
 */
@Tag(name = "企业知识产权植物新品种wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_ipr_plant_variety")
public class DataCompanyIprPlantVarietyAdminWapController extends AbstractBaseWapAdapter {
