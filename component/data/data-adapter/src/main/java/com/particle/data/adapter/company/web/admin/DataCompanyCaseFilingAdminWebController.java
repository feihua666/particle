...
public class DataCompanyCaseFilingAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyCaseFilingVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyCaseFilingVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyCaseFilingVO> queryDetail(CommonIdCommand detailCommand){
