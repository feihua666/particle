 ...
 */
@Tag(name = "企业股权出质wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_equity_pledge")
public class DataCompanyEquityPledgeAdminWapController extends AbstractBaseWapAdapter {
