 ...
 */
@Tag(name = "企业失信被执行人移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_discredited_judgment_debtor")
public class DataCompanyDiscreditedJudgmentDebtorFrontMobileController extends AbstractBaseMobileAdapter {
