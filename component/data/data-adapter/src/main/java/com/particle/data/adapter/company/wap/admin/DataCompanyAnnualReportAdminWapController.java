 ...
 */
@Tag(name = "企业年报wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_annual_report")
public class DataCompanyAnnualReportAdminWapController extends AbstractBaseWapAdapter {
