 ...
 */
@Tag(name = "企业知识产权地理标识pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_ipr_geogra")
public class DataCompanyIprGeograFrontWebController extends AbstractBaseWebAdapter {
