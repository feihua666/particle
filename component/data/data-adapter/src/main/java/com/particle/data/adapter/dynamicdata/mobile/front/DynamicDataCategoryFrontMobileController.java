 ...
 */
@Tag(name = "动态数据分类移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/dynamic_data_category")
public class DynamicDataCategoryFrontMobileController extends AbstractBaseMobileAdapter {
