 ...
 */
@Tag(name = "企业统计wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_statistic")
public class DataCompanyStatisticAdminWapController extends AbstractBaseWapAdapter {
