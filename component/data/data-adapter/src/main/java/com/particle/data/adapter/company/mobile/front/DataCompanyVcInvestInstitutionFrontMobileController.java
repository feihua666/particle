 ...
 */
@Tag(name = "企业投资机构移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_vc_invest_institution")
public class DataCompanyVcInvestInstitutionFrontMobileController extends AbstractBaseMobileAdapter {
