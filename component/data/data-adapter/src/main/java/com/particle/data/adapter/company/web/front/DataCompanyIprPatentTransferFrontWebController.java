 ...
 */
@Tag(name = "企业知识产权专利转让信息pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_ipr_patent_transfer")
public class DataCompanyIprPatentTransferFrontWebController extends AbstractBaseWebAdapter {
