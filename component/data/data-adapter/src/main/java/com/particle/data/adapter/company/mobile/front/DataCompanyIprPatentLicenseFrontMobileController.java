 ...
 */
@Tag(name = "企业知识产权专利许可信息移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_ipr_patent_license")
public class DataCompanyIprPatentLicenseFrontMobileController extends AbstractBaseMobileAdapter {
