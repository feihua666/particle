 ...
 */
@Tag(name = "企业知识产权专利缴费信息wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_ipr_patent_payment")
public class DataCompanyIprPatentPaymentAdminWapController extends AbstractBaseWapAdapter {
