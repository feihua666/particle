 ...
 */
@Tag(name = "企业基本信息pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_basic")
public class DataCompanyBasicFrontWebController extends AbstractBaseWebAdapter {
