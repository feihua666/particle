 ...
 */
@Tag(name = "企业个人移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_person")
public class DataCompanyPersonAdminMobileController extends AbstractBaseMobileAdapter {
