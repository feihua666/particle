 ...
 */
@Tag(name = "企业开庭公告移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_open_court_announcement")
public class DataCompanyOpenCourtAnnouncementAdminMobileController extends AbstractBaseMobileAdapter {
