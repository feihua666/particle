...
public class DataCompanyVcInvestInstitutionAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyVcInvestInstitutionVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyVcInvestInstitutionVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyVcInvestInstitutionVO> queryDetail(CommonIdCommand detailCommand){
