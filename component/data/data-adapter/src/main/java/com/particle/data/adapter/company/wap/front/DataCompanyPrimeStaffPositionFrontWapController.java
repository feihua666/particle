 ...
 */
@Tag(name = "企业主要人员职位wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_prime_staff_position")
public class DataCompanyPrimeStaffPositionFrontWapController extends AbstractBaseWapAdapter {
