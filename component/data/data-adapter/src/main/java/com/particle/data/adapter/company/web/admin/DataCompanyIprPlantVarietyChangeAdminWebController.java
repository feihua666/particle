...
public class DataCompanyIprPlantVarietyChangeAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyIprPlantVarietyChangeVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyIprPlantVarietyChangeVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyIprPlantVarietyChangeVO> queryDetail(CommonIdCommand detailCommand){
