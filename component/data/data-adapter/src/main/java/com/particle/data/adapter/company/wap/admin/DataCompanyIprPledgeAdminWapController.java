 ...
 */
@Tag(name = "企业知识产权出质wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_ipr_pledge")
public class DataCompanyIprPledgeAdminWapController extends AbstractBaseWapAdapter {
