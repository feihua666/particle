 ...
 */
@Tag(name = "企业法院公告当事人移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_court_announcement_party")
public class DataCompanyCourtAnnouncementPartyAdminMobileController extends AbstractBaseMobileAdapter {
