 ...
 */
@Tag(name = "企业裁判文书当事人移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_judgment_document_party")
public class DataCompanyJudgmentDocumentPartyFrontMobileController extends AbstractBaseMobileAdapter {
