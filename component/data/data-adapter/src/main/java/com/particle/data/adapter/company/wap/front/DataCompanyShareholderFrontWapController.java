 ...
 */
@Tag(name = "企业股东wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_shareholder")
public class DataCompanyShareholderFrontWapController extends AbstractBaseWapAdapter {
