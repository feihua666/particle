 ...
 */
@Tag(name = "企业知识产权地理标识wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_ipr_geogra")
public class DataCompanyIprGeograFrontWapController extends AbstractBaseWapAdapter {
