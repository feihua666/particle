 ...
 */
@Tag(name = "企业失信被执行人wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_discredited_judgment_debtor")
public class DataCompanyDiscreditedJudgmentDebtorAdminWapController extends AbstractBaseWapAdapter {
