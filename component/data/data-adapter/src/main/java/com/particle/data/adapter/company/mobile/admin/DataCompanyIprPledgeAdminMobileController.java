 ...
 */
@Tag(name = "企业知识产权出质移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_ipr_pledge")
public class DataCompanyIprPledgeAdminMobileController extends AbstractBaseMobileAdapter {
