...
public class DataCompanyAdministrativeLicenseAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyAdministrativeLicenseVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyAdministrativeLicenseVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyAdministrativeLicenseVO> queryDetail(CommonIdCommand detailCommand){
