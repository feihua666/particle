...
public class DataCompanyAnnualReportAssetsAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyAnnualReportAssetsVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyAnnualReportAssetsVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyAnnualReportAssetsVO> queryDetail(CommonIdCommand detailCommand){
