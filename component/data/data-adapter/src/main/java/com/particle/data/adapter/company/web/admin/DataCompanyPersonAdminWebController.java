...
public class DataCompanyPersonAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyPersonVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyPersonVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyPersonVO> queryDetail(CommonIdCommand detailCommand){
