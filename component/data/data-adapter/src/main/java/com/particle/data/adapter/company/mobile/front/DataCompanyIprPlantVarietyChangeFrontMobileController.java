 ...
 */
@Tag(name = "企业知识产权植物新品种变更信息移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_ipr_plant_variety_change")
public class DataCompanyIprPlantVarietyChangeFrontMobileController extends AbstractBaseMobileAdapter {
