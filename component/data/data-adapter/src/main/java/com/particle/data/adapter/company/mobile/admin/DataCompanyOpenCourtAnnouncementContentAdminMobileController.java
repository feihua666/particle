 ...
 */
@Tag(name = "企业开庭公告内容移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_open_court_announcement_content")
public class DataCompanyOpenCourtAnnouncementContentAdminMobileController extends AbstractBaseMobileAdapter {
