 ...
 */
@Tag(name = "企业开庭公告内容wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_open_court_announcement_content")
public class DataCompanyOpenCourtAnnouncementContentFrontWapController extends AbstractBaseWapAdapter {
