 ...
 */
@Tag(name = "企业终本案件pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_end_case")
public class DataCompanyEndCaseFrontWebController extends AbstractBaseWebAdapter {
