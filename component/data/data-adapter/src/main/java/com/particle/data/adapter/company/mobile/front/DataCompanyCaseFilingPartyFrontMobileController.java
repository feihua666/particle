 ...
 */
@Tag(name = "企业立案信息当事人移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_case_filing_party")
public class DataCompanyCaseFilingPartyFrontMobileController extends AbstractBaseMobileAdapter {
