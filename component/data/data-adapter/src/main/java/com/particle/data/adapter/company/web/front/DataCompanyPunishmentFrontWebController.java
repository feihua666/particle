 ...
 */
@Tag(name = "企业行政处罚pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_punishment")
public class DataCompanyPunishmentFrontWebController extends AbstractBaseWebAdapter {
