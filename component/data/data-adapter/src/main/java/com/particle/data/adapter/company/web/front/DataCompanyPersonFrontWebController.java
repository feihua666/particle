 ...
 */
@Tag(name = "企业个人pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_person")
public class DataCompanyPersonFrontWebController extends AbstractBaseWebAdapter {
