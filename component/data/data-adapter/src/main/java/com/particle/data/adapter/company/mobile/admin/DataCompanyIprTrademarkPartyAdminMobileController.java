 ...
 */
@Tag(name = "企业知识产权商标当事人移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_ipr_trademark_party")
public class DataCompanyIprTrademarkPartyAdminMobileController extends AbstractBaseMobileAdapter {
