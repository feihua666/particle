 ...
 */
@Tag(name = "企业知识产权地理标识移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_ipr_geogra")
public class DataCompanyIprGeograAdminMobileController extends AbstractBaseMobileAdapter {
