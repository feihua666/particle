...
public class DataCompanyAnnualReportShareholderAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyAnnualReportShareholderVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyAnnualReportShareholderVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyAnnualReportShareholderVO> queryDetail(CommonIdCommand detailCommand){
