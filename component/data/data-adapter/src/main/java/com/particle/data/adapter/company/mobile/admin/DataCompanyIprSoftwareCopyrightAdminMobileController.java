 ...
 */
@Tag(name = "企业知识产权软件著作移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_ipr_software_copyright")
public class DataCompanyIprSoftwareCopyrightAdminMobileController extends AbstractBaseMobileAdapter {
