...
public class DataCompanyOpenCourtAnnouncementContentAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyOpenCourtAnnouncementContentVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyOpenCourtAnnouncementContentVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyOpenCourtAnnouncementContentVO> queryDetail(CommonIdCommand detailCommand){
