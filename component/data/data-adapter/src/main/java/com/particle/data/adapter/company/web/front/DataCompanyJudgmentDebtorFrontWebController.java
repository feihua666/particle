 ...
 */
@Tag(name = "企业被执行人pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_judgment_debtor")
public class DataCompanyJudgmentDebtorFrontWebController extends AbstractBaseWebAdapter {
