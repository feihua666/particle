 ...
 */
@Tag(name = "企业法院公告移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_court_announcement")
public class DataCompanyCourtAnnouncementFrontMobileController extends AbstractBaseMobileAdapter {
