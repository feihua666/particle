 ...
 */
@Tag(name = "企业年报变更wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_annual_report_change")
public class DataCompanyAnnualReportChangeAdminWapController extends AbstractBaseWapAdapter {
