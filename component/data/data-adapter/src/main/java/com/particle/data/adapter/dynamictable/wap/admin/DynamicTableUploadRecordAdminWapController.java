 ...
 */
@Tag(name = "动态数据表格上传记录wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/dynamic_table_upload_record")
public class DynamicTableUploadRecordAdminWapController extends AbstractBaseWapAdapter {
