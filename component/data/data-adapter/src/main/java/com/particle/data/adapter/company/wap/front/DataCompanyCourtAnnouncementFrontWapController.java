 ...
 */
@Tag(name = "企业法院公告wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_court_announcement")
public class DataCompanyCourtAnnouncementFrontWapController extends AbstractBaseWapAdapter {
