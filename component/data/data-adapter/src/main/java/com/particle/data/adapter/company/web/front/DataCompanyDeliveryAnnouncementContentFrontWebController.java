 ...
 */
@Tag(name = "企业送达公告内容pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_delivery_announcement_content")
public class DataCompanyDeliveryAnnouncementContentFrontWebController extends AbstractBaseWebAdapter {
