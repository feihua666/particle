 ...
 */
@Tag(name = "企业投资机构移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_vc_invest_institution")
public class DataCompanyVcInvestInstitutionAdminMobileController extends AbstractBaseMobileAdapter {
