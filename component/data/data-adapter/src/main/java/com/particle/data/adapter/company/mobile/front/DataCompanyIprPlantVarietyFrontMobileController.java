 ...
 */
@Tag(name = "企业知识产权植物新品种移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_ipr_plant_variety")
public class DataCompanyIprPlantVarietyFrontMobileController extends AbstractBaseMobileAdapter {
