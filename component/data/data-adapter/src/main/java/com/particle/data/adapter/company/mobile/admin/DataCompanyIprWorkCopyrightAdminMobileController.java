 ...
 */
@Tag(name = "企业知识产权作品著作移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_ipr_work_copyright")
public class DataCompanyIprWorkCopyrightAdminMobileController extends AbstractBaseMobileAdapter {
