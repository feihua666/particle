 ...
 */
@Tag(name = "动态数据指标分类wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/dynamic_data_indicator_category")
public class DynamicDataIndicatorCategoryAdminWapController extends AbstractBaseWapAdapter {
