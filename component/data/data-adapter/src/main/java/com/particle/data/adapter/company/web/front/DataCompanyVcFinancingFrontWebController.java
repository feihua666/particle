 ...
 */
@Tag(name = "企业融资pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_vc_financing")
public class DataCompanyVcFinancingFrontWebController extends AbstractBaseWebAdapter {
