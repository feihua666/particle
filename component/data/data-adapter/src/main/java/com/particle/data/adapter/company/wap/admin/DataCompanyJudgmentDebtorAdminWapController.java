 ...
 */
@Tag(name = "企业被执行人wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_judgment_debtor")
public class DataCompanyJudgmentDebtorAdminWapController extends AbstractBaseWapAdapter {
