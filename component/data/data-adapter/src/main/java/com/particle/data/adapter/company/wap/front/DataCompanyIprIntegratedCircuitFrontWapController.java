 ...
 */
@Tag(name = "企业知识产权集成电路wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_ipr_integrated_circuit")
public class DataCompanyIprIntegratedCircuitFrontWapController extends AbstractBaseWapAdapter {
