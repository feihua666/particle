 ...
 */
@Tag(name = "企业融资产品竞品关系wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_vc_product_competitive_product_rel")
public class DataCompanyVcProductCompetitiveProductRelAdminWapController extends AbstractBaseWapAdapter {
