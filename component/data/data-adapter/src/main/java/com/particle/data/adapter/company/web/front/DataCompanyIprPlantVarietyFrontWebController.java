 ...
 */
@Tag(name = "企业知识产权植物新品种pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_ipr_plant_variety")
public class DataCompanyIprPlantVarietyFrontWebController extends AbstractBaseWebAdapter {
