 ...
 */
@Tag(name = "企业知识产权专利同族信息移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_ipr_patent_family")
public class DataCompanyIprPatentFamilyFrontMobileController extends AbstractBaseMobileAdapter {
