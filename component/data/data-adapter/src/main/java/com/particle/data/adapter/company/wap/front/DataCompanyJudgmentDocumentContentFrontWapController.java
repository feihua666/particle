 ...
 */
@Tag(name = "企业裁判文书内容wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_judgment_document_content")
public class DataCompanyJudgmentDocumentContentFrontWapController extends AbstractBaseWapAdapter {
