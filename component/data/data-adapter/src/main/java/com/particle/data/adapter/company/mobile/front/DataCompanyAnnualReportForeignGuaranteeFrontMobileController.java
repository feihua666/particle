 ...
 */
@Tag(name = "企业年报对外担保移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_annual_report_foreign_guarantee")
public class DataCompanyAnnualReportForeignGuaranteeFrontMobileController extends AbstractBaseMobileAdapter {
