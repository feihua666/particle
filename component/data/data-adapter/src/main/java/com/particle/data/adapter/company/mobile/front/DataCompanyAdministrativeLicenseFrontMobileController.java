 ...
 */
@Tag(name = "企业行政许可移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_administrative_license")
public class DataCompanyAdministrativeLicenseFrontMobileController extends AbstractBaseMobileAdapter {
