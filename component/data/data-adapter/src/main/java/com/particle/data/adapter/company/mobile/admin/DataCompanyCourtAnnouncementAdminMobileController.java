 ...
 */
@Tag(name = "企业法院公告移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_court_announcement")
public class DataCompanyCourtAnnouncementAdminMobileController extends AbstractBaseMobileAdapter {
