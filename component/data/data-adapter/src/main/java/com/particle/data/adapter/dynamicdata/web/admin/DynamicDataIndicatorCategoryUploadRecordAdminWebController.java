...
public class DynamicDataIndicatorCategoryUploadRecordAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DynamicDataIndicatorCategoryUploadRecordVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DynamicDataIndicatorCategoryUploadRecordVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DynamicDataIndicatorCategoryUploadRecordVO> queryDetail(CommonIdCommand detailCommand){
    ...
    public SingleResponse<DynamicDataIndicatorCategoryUploadRecordVO> publish(@RequestBody CommonIdCommand publishCommand){
