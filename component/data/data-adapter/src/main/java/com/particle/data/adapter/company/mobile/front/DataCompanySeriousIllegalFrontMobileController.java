 ...
 */
@Tag(name = "企业严重违法移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_serious_illegal")
public class DataCompanySeriousIllegalFrontMobileController extends AbstractBaseMobileAdapter {
