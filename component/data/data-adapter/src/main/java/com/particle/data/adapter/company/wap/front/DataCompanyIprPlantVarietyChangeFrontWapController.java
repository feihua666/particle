 ...
 */
@Tag(name = "企业知识产权植物新品种变更信息wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_ipr_plant_variety_change")
public class DataCompanyIprPlantVarietyChangeFrontWapController extends AbstractBaseWapAdapter {
