 ...
 */
@Tag(name = "企业终本案件移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_end_case")
public class DataCompanyEndCaseFrontMobileController extends AbstractBaseMobileAdapter {
