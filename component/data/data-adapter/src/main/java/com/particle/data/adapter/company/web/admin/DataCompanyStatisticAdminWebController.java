...
public class DataCompanyStatisticAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyStatisticVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyStatisticVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyStatisticVO> queryDetail(CommonIdCommand detailCommand){
