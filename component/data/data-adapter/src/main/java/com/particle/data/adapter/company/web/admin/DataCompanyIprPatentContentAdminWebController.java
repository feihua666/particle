...
public class DataCompanyIprPatentContentAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyIprPatentContentVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyIprPatentContentVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyIprPatentContentVO> queryDetail(CommonIdCommand detailCommand){
