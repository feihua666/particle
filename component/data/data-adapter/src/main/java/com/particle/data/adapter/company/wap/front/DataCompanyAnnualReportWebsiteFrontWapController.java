 ...
 */
@Tag(name = "企业年报网站网店wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_annual_report_website")
public class DataCompanyAnnualReportWebsiteFrontWapController extends AbstractBaseWapAdapter {
