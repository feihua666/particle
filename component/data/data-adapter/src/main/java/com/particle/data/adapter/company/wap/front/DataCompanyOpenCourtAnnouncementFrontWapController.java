 ...
 */
@Tag(name = "企业开庭公告wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_open_court_announcement")
public class DataCompanyOpenCourtAnnouncementFrontWapController extends AbstractBaseWapAdapter {
