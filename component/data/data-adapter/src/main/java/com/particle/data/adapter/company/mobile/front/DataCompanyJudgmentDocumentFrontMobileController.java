 ...
 */
@Tag(name = "企业裁判文书移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_judgment_document")
public class DataCompanyJudgmentDocumentFrontMobileController extends AbstractBaseMobileAdapter {
