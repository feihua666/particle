 ...
 */
@Tag(name = "企业开庭公告内容wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_open_court_announcement_content")
public class DataCompanyOpenCourtAnnouncementContentAdminWapController extends AbstractBaseWapAdapter {
