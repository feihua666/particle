 ...
 */
@Tag(name = "企业年报股东pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_annual_report_shareholder")
public class DataCompanyAnnualReportShareholderFrontWebController extends AbstractBaseWebAdapter {
