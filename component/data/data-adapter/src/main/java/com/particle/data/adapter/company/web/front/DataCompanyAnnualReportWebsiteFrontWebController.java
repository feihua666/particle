 ...
 */
@Tag(name = "企业年报网站网店pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_annual_report_website")
public class DataCompanyAnnualReportWebsiteFrontWebController extends AbstractBaseWebAdapter {
