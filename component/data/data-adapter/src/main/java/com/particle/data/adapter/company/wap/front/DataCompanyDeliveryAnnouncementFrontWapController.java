 ...
 */
@Tag(name = "企业送达公告wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_delivery_announcement")
public class DataCompanyDeliveryAnnouncementFrontWapController extends AbstractBaseWapAdapter {
