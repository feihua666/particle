 ...
 */
@Tag(name = "企业知识产权专利当事人pc或平板端后台管理相关接口")
@RestController
...
public class DataCompanyIprPatentPartyAdminWebController extends AbstractBaseWebAdapter {
    ...
    @Operation(summary = "添加企业知识产权专利当事人")
    @PostMapping("/create")
    @OpLog(name = "添加企业知识产权专利当事人",module = OpLogConstants.Module.unknown,type = OpLogConstants.Type.create)
    ...
    @Operation(summary = "删除企业知识产权专利当事人")
    @DeleteMapping("/delete")
    @OpLog(name = "删除企业知识产权专利当事人",module = OpLogConstants.Module.unknown,type = OpLogConstants.Type.delete)
    public SingleResponse<DataCompanyIprPatentPartyVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    @Operation(summary = "更新企业知识产权专利当事人")
    @PutMapping("/update")
    @OpLog(name = "更新企业知识产权专利当事人",module = OpLogConstants.Module.unknown,type = OpLogConstants.Type.update)
    ...
    @PreAuthorize("hasAuthority('admin:web:dataCompanyIprPatentParty:update')")
    @Operation(summary = "企业知识产权专利当事人更新详情")
    @GetMapping("/detail-for-update")
    public SingleResponse<DataCompanyIprPatentPartyVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @Operation(summary = "企业知识产权专利当事人详情展示")
    @GetMapping("/detail")
    public SingleResponse<DataCompanyIprPatentPartyVO> queryDetail(CommonIdCommand detailCommand){
    ...
    @Operation(summary = "列表查询企业知识产权专利当事人")
    @GetMapping("/list")
    ...
    @Operation(summary = "分页查询企业知识产权专利当事人")
    @GetMapping("/page")
