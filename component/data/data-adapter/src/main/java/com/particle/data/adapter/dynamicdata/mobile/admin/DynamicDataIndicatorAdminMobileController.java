 ...
 */
@Tag(name = "动态数据指标移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/dynamic_data_indicator")
public class DynamicDataIndicatorAdminMobileController extends AbstractBaseMobileAdapter {
