 ...
 */
@Tag(name = "企业限制高消费pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_restrict_high_consume")
public class DataCompanyRestrictHighConsumeFrontWebController extends AbstractBaseWebAdapter {
