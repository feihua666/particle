 ...
 */
@Tag(name = "企业法院公告内容移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_court_announcement_content")
public class DataCompanyCourtAnnouncementContentFrontMobileController extends AbstractBaseMobileAdapter {
