 ...
 */
@Tag(name = "企业基本信息移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_basic")
public class DataCompanyBasicFrontMobileController extends AbstractBaseMobileAdapter {
