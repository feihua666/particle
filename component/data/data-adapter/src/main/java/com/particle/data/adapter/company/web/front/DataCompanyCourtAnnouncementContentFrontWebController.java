 ...
 */
@Tag(name = "企业法院公告内容pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_court_announcement_content")
public class DataCompanyCourtAnnouncementContentFrontWebController extends AbstractBaseWebAdapter {
