 ...
 */
@Tag(name = "企业主要人员职位移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_prime_staff_position")
public class DataCompanyPrimeStaffPositionAdminMobileController extends AbstractBaseMobileAdapter {
