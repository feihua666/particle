 ...
 */
@Tag(name = "企业知识产权软件著作pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_ipr_software_copyright")
public class DataCompanyIprSoftwareCopyrightFrontWebController extends AbstractBaseWebAdapter {
