 ...
 */
@Tag(name = "企业裁判文书wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_judgment_document")
public class DataCompanyJudgmentDocumentFrontWapController extends AbstractBaseWapAdapter {
