...
public class DataCompanyIprTrademarkTransferAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyIprTrademarkTransferVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyIprTrademarkTransferVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyIprTrademarkTransferVO> queryDetail(CommonIdCommand detailCommand){
