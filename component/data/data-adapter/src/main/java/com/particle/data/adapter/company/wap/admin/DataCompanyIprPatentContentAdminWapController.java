 ...
 */
@Tag(name = "企业知识产权专利内容wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_ipr_patent_content")
public class DataCompanyIprPatentContentAdminWapController extends AbstractBaseWapAdapter {
