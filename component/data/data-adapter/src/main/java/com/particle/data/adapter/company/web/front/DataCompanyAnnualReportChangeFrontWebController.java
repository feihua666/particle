 ...
 */
@Tag(name = "企业年报变更pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_annual_report_change")
public class DataCompanyAnnualReportChangeFrontWebController extends AbstractBaseWebAdapter {
