 ...
 */
@Tag(name = "企业知识产权专利移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_ipr_patent")
public class DataCompanyIprPatentFrontMobileController extends AbstractBaseMobileAdapter {
