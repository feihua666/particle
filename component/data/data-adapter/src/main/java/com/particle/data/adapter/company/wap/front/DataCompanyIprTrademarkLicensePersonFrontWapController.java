 ...
 */
@Tag(name = "企业知识产权商标许可人wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_ipr_trademark_license_person")
public class DataCompanyIprTrademarkLicensePersonFrontWapController extends AbstractBaseWapAdapter {
