 ...
 */
@Tag(name = "企业基本信息移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_basic")
public class DataCompanyBasicAdminMobileController extends AbstractBaseMobileAdapter {
