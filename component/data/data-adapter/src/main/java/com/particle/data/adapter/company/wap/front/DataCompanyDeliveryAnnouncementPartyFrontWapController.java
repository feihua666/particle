 ...
 */
@Tag(name = "企业送达公告当事人wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_delivery_announcement_party")
public class DataCompanyDeliveryAnnouncementPartyFrontWapController extends AbstractBaseWapAdapter {
