 ...
 */
@Tag(name = "企业md5移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_md5")
public class DataCompanyMd5FrontMobileController extends AbstractBaseMobileAdapter {
