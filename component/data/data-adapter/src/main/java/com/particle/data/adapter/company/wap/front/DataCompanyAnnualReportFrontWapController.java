 ...
 */
@Tag(name = "企业年报wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_annual_report")
public class DataCompanyAnnualReportFrontWapController extends AbstractBaseWapAdapter {
