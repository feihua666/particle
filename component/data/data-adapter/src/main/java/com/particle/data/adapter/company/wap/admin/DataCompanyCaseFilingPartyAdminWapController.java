 ...
 */
@Tag(name = "企业立案信息当事人wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_case_filing_party")
public class DataCompanyCaseFilingPartyAdminWapController extends AbstractBaseWapAdapter {
