 ...
 */
@Tag(name = "企业知识产权商标许可人wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_ipr_trademark_license_person")
public class DataCompanyIprTrademarkLicensePersonAdminWapController extends AbstractBaseWapAdapter {
