 ...
 */
@Tag(name = "企业知识产权专利被引证信息wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_ipr_patent_cited")
public class DataCompanyIprPatentCitedAdminWapController extends AbstractBaseWapAdapter {
