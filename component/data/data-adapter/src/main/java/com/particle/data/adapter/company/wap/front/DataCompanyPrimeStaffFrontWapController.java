 ...
 */
@Tag(name = "企业主要人员wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_prime_staff")
public class DataCompanyPrimeStaffFrontWapController extends AbstractBaseWapAdapter {
