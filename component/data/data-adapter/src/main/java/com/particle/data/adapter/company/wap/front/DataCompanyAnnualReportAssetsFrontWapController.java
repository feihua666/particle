 ...
 */
@Tag(name = "企业资产状况信息wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_annual_report_assets")
public class DataCompanyAnnualReportAssetsFrontWapController extends AbstractBaseWapAdapter {
