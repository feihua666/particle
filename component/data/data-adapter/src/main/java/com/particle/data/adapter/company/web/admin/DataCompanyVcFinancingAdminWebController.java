...
public class DataCompanyVcFinancingAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyVcFinancingVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyVcFinancingVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyVcFinancingVO> queryDetail(CommonIdCommand detailCommand){
