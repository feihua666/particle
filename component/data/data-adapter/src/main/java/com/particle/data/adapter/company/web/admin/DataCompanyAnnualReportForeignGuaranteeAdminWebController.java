...
public class DataCompanyAnnualReportForeignGuaranteeAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyAnnualReportForeignGuaranteeVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyAnnualReportForeignGuaranteeVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyAnnualReportForeignGuaranteeVO> queryDetail(CommonIdCommand detailCommand){
