 ...
 */
@Tag(name = "企业知识产权作品著作移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_ipr_work_copyright")
public class DataCompanyIprWorkCopyrightFrontMobileController extends AbstractBaseMobileAdapter {
