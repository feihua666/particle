...
public class DataCompanyIprPatentPledgeAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyIprPatentPledgeVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyIprPatentPledgeVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyIprPatentPledgeVO> queryDetail(CommonIdCommand detailCommand){
