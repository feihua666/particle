 ...
 */
@Tag(name = "企业知识产权植物新品种移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_ipr_plant_variety")
public class DataCompanyIprPlantVarietyAdminMobileController extends AbstractBaseMobileAdapter {
