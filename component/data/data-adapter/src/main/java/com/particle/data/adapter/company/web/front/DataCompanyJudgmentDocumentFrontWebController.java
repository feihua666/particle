 ...
 */
@Tag(name = "企业裁判文书pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_judgment_document")
public class DataCompanyJudgmentDocumentFrontWebController extends AbstractBaseWebAdapter {
