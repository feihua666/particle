 ...
 */
@Tag(name = "企业知识产权专利证书信息移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_ipr_patent_certificate")
public class DataCompanyIprPatentCertificateAdminMobileController extends AbstractBaseMobileAdapter {
