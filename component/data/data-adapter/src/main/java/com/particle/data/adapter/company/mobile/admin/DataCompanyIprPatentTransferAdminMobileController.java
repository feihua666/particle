 ...
 */
@Tag(name = "企业知识产权专利转让信息移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_ipr_patent_transfer")
public class DataCompanyIprPatentTransferAdminMobileController extends AbstractBaseMobileAdapter {
