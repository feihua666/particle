 ...
 */
@Tag(name = "企业知识产权专利统计移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_ipr_patent_statistic")
public class DataCompanyIprPatentStatisticAdminMobileController extends AbstractBaseMobileAdapter {
