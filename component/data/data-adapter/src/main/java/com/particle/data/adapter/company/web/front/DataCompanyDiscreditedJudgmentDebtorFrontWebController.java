 ...
 */
@Tag(name = "企业失信被执行人pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_discredited_judgment_debtor")
public class DataCompanyDiscreditedJudgmentDebtorFrontWebController extends AbstractBaseWebAdapter {
