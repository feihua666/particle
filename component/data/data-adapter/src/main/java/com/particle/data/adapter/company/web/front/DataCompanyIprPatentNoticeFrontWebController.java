 ...
 */
@Tag(name = "企业知识产权专利通知书信息pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_ipr_patent_notice")
public class DataCompanyIprPatentNoticeFrontWebController extends AbstractBaseWebAdapter {
