...
public class DataCompanyAnnualReportSocialSecurityAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyAnnualReportSocialSecurityVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyAnnualReportSocialSecurityVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyAnnualReportSocialSecurityVO> queryDetail(CommonIdCommand detailCommand){
