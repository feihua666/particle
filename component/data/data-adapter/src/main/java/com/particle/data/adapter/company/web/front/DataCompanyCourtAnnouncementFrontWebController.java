 ...
 */
@Tag(name = "企业法院公告pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_court_announcement")
public class DataCompanyCourtAnnouncementFrontWebController extends AbstractBaseWebAdapter {
