 ...
 */
@Tag(name = "企业知识产权专利统计wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_ipr_patent_statistic")
public class DataCompanyIprPatentStatisticFrontWapController extends AbstractBaseWapAdapter {
