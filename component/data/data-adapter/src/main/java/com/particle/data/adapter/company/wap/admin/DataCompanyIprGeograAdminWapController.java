 ...
 */
@Tag(name = "企业知识产权地理标识wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_ipr_geogra")
public class DataCompanyIprGeograAdminWapController extends AbstractBaseWapAdapter {
