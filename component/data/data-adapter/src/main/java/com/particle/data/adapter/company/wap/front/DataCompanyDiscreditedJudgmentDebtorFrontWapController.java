 ...
 */
@Tag(name = "企业失信被执行人wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_discredited_judgment_debtor")
public class DataCompanyDiscreditedJudgmentDebtorFrontWapController extends AbstractBaseWapAdapter {
