 ...
 */
@Tag(name = "企业投资机构wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_vc_invest_institution")
public class DataCompanyVcInvestInstitutionAdminWapController extends AbstractBaseWapAdapter {
