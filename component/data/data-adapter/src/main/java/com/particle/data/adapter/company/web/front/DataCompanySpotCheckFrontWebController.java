 ...
 */
@Tag(name = "企业抽查检查pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_spot_check")
public class DataCompanySpotCheckFrontWebController extends AbstractBaseWebAdapter {
