...
public class DataCompanyShareholderAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyShareholderVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyShareholderVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyShareholderVO> queryDetail(CommonIdCommand detailCommand){
