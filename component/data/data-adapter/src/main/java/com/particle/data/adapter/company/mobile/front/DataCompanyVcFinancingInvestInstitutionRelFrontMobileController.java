 ...
 */
@Tag(name = "企业融资历史投资机构关系移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_vc_financing_invest_institution_rel")
public class DataCompanyVcFinancingInvestInstitutionRelFrontMobileController extends AbstractBaseMobileAdapter {
