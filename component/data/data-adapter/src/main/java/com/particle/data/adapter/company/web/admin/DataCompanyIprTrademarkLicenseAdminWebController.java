...
public class DataCompanyIprTrademarkLicenseAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyIprTrademarkLicenseVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyIprTrademarkLicenseVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyIprTrademarkLicenseVO> queryDetail(CommonIdCommand detailCommand){
