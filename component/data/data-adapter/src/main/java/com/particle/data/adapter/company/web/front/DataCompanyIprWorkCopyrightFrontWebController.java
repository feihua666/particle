 ...
 */
@Tag(name = "企业知识产权作品著作pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_ipr_work_copyright")
public class DataCompanyIprWorkCopyrightFrontWebController extends AbstractBaseWebAdapter {
