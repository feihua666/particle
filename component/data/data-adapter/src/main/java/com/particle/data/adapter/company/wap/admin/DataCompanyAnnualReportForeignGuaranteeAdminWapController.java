 ...
 */
@Tag(name = "企业年报对外担保wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_annual_report_foreign_guarantee")
public class DataCompanyAnnualReportForeignGuaranteeAdminWapController extends AbstractBaseWapAdapter {
