 ...
 */
@Tag(name = "企业股东wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_shareholder")
public class DataCompanyShareholderAdminWapController extends AbstractBaseWapAdapter {
