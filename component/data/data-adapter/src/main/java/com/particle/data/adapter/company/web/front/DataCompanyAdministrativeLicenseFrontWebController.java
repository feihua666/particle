 ...
 */
@Tag(name = "企业行政许可pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_administrative_license")
public class DataCompanyAdministrativeLicenseFrontWebController extends AbstractBaseWebAdapter {
