 ...
 */
@Tag(name = "企业年报pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_annual_report")
public class DataCompanyAnnualReportFrontWebController extends AbstractBaseWebAdapter {
