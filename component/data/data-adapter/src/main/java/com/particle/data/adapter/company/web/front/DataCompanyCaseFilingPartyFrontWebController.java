 ...
 */
@Tag(name = "企业立案信息当事人pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_case_filing_party")
public class DataCompanyCaseFilingPartyFrontWebController extends AbstractBaseWebAdapter {
