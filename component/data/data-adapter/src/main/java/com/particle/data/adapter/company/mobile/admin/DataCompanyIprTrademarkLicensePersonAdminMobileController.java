 ...
 */
@Tag(name = "企业知识产权商标许可人移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_ipr_trademark_license_person")
public class DataCompanyIprTrademarkLicensePersonAdminMobileController extends AbstractBaseMobileAdapter {
