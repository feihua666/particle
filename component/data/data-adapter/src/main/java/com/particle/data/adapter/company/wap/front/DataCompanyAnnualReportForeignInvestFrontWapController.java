 ...
 */
@Tag(name = "企业年报对外投资wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_annual_report_foreign_invest")
public class DataCompanyAnnualReportForeignInvestFrontWapController extends AbstractBaseWapAdapter {
