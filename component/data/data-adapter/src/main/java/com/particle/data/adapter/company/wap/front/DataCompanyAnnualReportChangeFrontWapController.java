 ...
 */
@Tag(name = "企业年报变更wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_annual_report_change")
public class DataCompanyAnnualReportChangeFrontWapController extends AbstractBaseWapAdapter {
