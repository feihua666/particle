 ...
 */
@Tag(name = "企业开庭公告当事人pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_open_court_announcement_party")
public class DataCompanyOpenCourtAnnouncementPartyFrontWebController extends AbstractBaseWebAdapter {
