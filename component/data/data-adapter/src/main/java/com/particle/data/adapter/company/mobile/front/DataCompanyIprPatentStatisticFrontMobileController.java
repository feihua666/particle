 ...
 */
@Tag(name = "企业知识产权专利统计移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_ipr_patent_statistic")
public class DataCompanyIprPatentStatisticFrontMobileController extends AbstractBaseMobileAdapter {
