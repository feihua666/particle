 ...
 */
@Tag(name = "企业知识产权商标转让信息移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_ipr_trademark_transfer")
public class DataCompanyIprTrademarkTransferFrontMobileController extends AbstractBaseMobileAdapter {
