 ...
 */
@Tag(name = "企业严重违法移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_serious_illegal")
public class DataCompanySeriousIllegalAdminMobileController extends AbstractBaseMobileAdapter {
