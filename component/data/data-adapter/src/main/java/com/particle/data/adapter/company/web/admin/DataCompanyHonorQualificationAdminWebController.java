...
public class DataCompanyHonorQualificationAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyHonorQualificationVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyHonorQualificationVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyHonorQualificationVO> queryDetail(CommonIdCommand detailCommand){
