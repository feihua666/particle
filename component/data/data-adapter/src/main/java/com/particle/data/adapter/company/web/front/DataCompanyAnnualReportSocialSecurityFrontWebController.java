 ...
 */
@Tag(name = "企业年报社保pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_annual_report_social_security")
public class DataCompanyAnnualReportSocialSecurityFrontWebController extends AbstractBaseWebAdapter {
