...
public class DataCompanyIprWorkCopyrightAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyIprWorkCopyrightVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyIprWorkCopyrightVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyIprWorkCopyrightVO> queryDetail(CommonIdCommand detailCommand){
