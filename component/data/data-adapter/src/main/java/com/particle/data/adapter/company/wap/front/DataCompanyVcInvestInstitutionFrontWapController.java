 ...
 */
@Tag(name = "企业投资机构wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_vc_invest_institution")
public class DataCompanyVcInvestInstitutionFrontWapController extends AbstractBaseWapAdapter {
