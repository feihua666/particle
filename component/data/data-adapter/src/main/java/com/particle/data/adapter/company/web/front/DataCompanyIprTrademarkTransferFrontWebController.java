 ...
 */
@Tag(name = "企业知识产权商标转让信息pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_ipr_trademark_transfer")
public class DataCompanyIprTrademarkTransferFrontWebController extends AbstractBaseWebAdapter {
