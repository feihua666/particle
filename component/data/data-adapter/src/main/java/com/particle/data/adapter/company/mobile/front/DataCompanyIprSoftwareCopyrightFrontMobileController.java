 ...
 */
@Tag(name = "企业知识产权软件著作移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_ipr_software_copyright")
public class DataCompanyIprSoftwareCopyrightFrontMobileController extends AbstractBaseMobileAdapter {
