 ...
 */
@Tag(name = "企业知识产权专利许可信息wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_ipr_patent_license")
public class DataCompanyIprPatentLicenseFrontWapController extends AbstractBaseWapAdapter {
