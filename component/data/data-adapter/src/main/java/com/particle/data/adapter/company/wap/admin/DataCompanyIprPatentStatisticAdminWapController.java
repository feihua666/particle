 ...
 */
@Tag(name = "企业知识产权专利统计wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_ipr_patent_statistic")
public class DataCompanyIprPatentStatisticAdminWapController extends AbstractBaseWapAdapter {
