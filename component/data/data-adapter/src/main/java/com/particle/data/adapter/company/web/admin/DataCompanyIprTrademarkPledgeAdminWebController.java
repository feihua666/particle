...
public class DataCompanyIprTrademarkPledgeAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyIprTrademarkPledgeVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyIprTrademarkPledgeVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyIprTrademarkPledgeVO> queryDetail(CommonIdCommand detailCommand){
