 ...
 */
@Tag(name = "动态数据表格字段wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/dynamic_table_field")
public class DynamicTableFieldFrontWapController extends AbstractBaseWapAdapter {
