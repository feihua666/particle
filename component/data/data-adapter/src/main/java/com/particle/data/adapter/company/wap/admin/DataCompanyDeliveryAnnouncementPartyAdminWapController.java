 ...
 */
@Tag(name = "企业送达公告当事人wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_delivery_announcement_party")
public class DataCompanyDeliveryAnnouncementPartyAdminWapController extends AbstractBaseWapAdapter {
