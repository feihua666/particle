 ...
 */
@Tag(name = "企业年报行政许可wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_annual_report_administrative_license")
public class DataCompanyAnnualReportAdministrativeLicenseFrontWapController extends AbstractBaseWapAdapter {
