 ...
 */
@Tag(name = "企业年报股东wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_annual_report_shareholder")
public class DataCompanyAnnualReportShareholderFrontWapController extends AbstractBaseWapAdapter {
