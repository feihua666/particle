 ...
 */
@Tag(name = "企业送达公告当事人移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_delivery_announcement_party")
public class DataCompanyDeliveryAnnouncementPartyFrontMobileController extends AbstractBaseMobileAdapter {
