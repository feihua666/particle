 ...
 */
@Tag(name = "企业开庭公告内容移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_open_court_announcement_content")
public class DataCompanyOpenCourtAnnouncementContentFrontMobileController extends AbstractBaseMobileAdapter {
