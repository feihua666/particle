...
public class DataCompanyIprPatentFamilyAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyIprPatentFamilyVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyIprPatentFamilyVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyIprPatentFamilyVO> queryDetail(CommonIdCommand detailCommand){
