...
public class DataCompanyOpenCourtAnnouncementAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyOpenCourtAnnouncementVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyOpenCourtAnnouncementVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyOpenCourtAnnouncementVO> queryDetail(CommonIdCommand detailCommand){
