 ...
 */
@Tag(name = "企业知识产权集成电路pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_ipr_integrated_circuit")
public class DataCompanyIprIntegratedCircuitFrontWebController extends AbstractBaseWebAdapter {
