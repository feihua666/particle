 ...
 */
@Tag(name = "企业开庭公告pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_open_court_announcement")
public class DataCompanyOpenCourtAnnouncementFrontWebController extends AbstractBaseWebAdapter {
