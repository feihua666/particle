 ...
 */
@Tag(name = "企业融资wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_vc_financing")
public class DataCompanyVcFinancingAdminWapController extends AbstractBaseWapAdapter {
