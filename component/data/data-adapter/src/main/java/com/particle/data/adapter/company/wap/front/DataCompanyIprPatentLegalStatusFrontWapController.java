 ...
 */
@Tag(name = "企业知识产权专利法律状态wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_ipr_patent_legal_status")
public class DataCompanyIprPatentLegalStatusFrontWapController extends AbstractBaseWapAdapter {
