 ...
 */
@Tag(name = "企业年报对外担保pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_annual_report_foreign_guarantee")
public class DataCompanyAnnualReportForeignGuaranteeFrontWebController extends AbstractBaseWebAdapter {
