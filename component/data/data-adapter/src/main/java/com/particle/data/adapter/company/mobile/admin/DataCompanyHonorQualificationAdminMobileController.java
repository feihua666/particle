 ...
 */
@Tag(name = "企业荣誉资质移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_honor_qualification")
public class DataCompanyHonorQualificationAdminMobileController extends AbstractBaseMobileAdapter {
