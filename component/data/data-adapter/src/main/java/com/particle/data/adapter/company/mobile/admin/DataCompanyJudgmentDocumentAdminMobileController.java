 ...
 */
@Tag(name = "企业裁判文书移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_judgment_document")
public class DataCompanyJudgmentDocumentAdminMobileController extends AbstractBaseMobileAdapter {
