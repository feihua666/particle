 ...
 */
@Tag(name = "企业股东移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_shareholder")
public class DataCompanyShareholderAdminMobileController extends AbstractBaseMobileAdapter {
