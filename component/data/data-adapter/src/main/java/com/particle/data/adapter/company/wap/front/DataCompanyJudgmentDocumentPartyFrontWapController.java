 ...
 */
@Tag(name = "企业裁判文书当事人wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_judgment_document_party")
public class DataCompanyJudgmentDocumentPartyFrontWapController extends AbstractBaseWapAdapter {
