 ...
 */
@Tag(name = "企业知识产权地理标识核准公告移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_ipr_geogra_approve_announcement")
public class DataCompanyIprGeograApproveAnnouncementAdminMobileController extends AbstractBaseMobileAdapter {
