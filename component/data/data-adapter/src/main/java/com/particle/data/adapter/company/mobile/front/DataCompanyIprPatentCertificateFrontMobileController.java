 ...
 */
@Tag(name = "企业知识产权专利证书信息移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_ipr_patent_certificate")
public class DataCompanyIprPatentCertificateFrontMobileController extends AbstractBaseMobileAdapter {
