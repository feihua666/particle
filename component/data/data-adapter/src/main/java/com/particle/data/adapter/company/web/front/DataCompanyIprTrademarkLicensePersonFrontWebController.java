 ...
 */
@Tag(name = "企业知识产权商标许可人pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_ipr_trademark_license_person")
public class DataCompanyIprTrademarkLicensePersonFrontWebController extends AbstractBaseWebAdapter {
