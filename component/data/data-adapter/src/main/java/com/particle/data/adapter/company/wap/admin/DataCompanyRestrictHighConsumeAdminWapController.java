 ...
 */
@Tag(name = "企业限制高消费wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_restrict_high_consume")
public class DataCompanyRestrictHighConsumeAdminWapController extends AbstractBaseWapAdapter {
