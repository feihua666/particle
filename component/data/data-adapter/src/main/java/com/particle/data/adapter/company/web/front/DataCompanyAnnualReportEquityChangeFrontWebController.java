 ...
 */
@Tag(name = "企业年报股权变更pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_annual_report_equity_change")
public class DataCompanyAnnualReportEquityChangeFrontWebController extends AbstractBaseWebAdapter {
