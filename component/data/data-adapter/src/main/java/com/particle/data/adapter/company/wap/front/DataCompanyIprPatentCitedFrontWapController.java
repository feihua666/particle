 ...
 */
@Tag(name = "企业知识产权专利被引证信息wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_ipr_patent_cited")
public class DataCompanyIprPatentCitedFrontWapController extends AbstractBaseWapAdapter {
