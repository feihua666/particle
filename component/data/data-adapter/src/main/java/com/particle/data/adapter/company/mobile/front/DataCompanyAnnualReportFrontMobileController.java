 ...
 */
@Tag(name = "企业年报移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_annual_report")
public class DataCompanyAnnualReportFrontMobileController extends AbstractBaseMobileAdapter {
