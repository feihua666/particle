 ...
 */
@Tag(name = "企业年报变更移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_annual_report_change")
public class DataCompanyAnnualReportChangeFrontMobileController extends AbstractBaseMobileAdapter {
