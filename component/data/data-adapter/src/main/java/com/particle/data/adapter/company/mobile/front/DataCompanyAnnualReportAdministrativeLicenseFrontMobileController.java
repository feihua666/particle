 ...
 */
@Tag(name = "企业年报行政许可移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/data_company_annual_report_administrative_license")
public class DataCompanyAnnualReportAdministrativeLicenseFrontMobileController extends AbstractBaseMobileAdapter {
