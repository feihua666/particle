 ...
 */
@Tag(name = "企业严重违法wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_serious_illegal")
public class DataCompanySeriousIllegalAdminWapController extends AbstractBaseWapAdapter {
