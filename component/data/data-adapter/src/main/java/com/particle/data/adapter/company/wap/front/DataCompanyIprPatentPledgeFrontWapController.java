 ...
 */
@Tag(name = "企业知识产权专利质押信息wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_ipr_patent_pledge")
public class DataCompanyIprPatentPledgeFrontWapController extends AbstractBaseWapAdapter {
