 ...
 */
@Tag(name = "企业送达公告当事人pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_delivery_announcement_party")
public class DataCompanyDeliveryAnnouncementPartyFrontWebController extends AbstractBaseWebAdapter {
