...
public class DataCompanyPrimeStaffAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyPrimeStaffVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyPrimeStaffVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyPrimeStaffVO> queryDetail(CommonIdCommand detailCommand){
