...
public class DataCompanyJudgmentDebtorAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyJudgmentDebtorVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyJudgmentDebtorVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyJudgmentDebtorVO> queryDetail(CommonIdCommand detailCommand){
