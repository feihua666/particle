 ...
 */
@Tag(name = "企业知识产权专利通知书信息移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/data_company_ipr_patent_notice")
public class DataCompanyIprPatentNoticeAdminMobileController extends AbstractBaseMobileAdapter {
