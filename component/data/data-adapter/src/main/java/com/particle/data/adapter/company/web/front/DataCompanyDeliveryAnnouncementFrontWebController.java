 ...
 */
@Tag(name = "企业送达公告pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_delivery_announcement")
public class DataCompanyDeliveryAnnouncementFrontWebController extends AbstractBaseWebAdapter {
