 ...
 */
@Tag(name = "企业荣誉资质pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/data_company_honor_qualification")
public class DataCompanyHonorQualificationFrontWebController extends AbstractBaseWebAdapter {
