 ...
 */
@Tag(name = "企业立案信息当事人wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/data_company_case_filing_party")
public class DataCompanyCaseFilingPartyFrontWapController extends AbstractBaseWapAdapter {
