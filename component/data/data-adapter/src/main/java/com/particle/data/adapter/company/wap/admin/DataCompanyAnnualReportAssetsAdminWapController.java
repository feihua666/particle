 ...
 */
@Tag(name = "企业资产状况信息wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_company_annual_report_assets")
public class DataCompanyAnnualReportAssetsAdminWapController extends AbstractBaseWapAdapter {
