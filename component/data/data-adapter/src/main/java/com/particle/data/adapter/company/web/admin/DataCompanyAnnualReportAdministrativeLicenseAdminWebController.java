...
public class DataCompanyAnnualReportAdministrativeLicenseAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<DataCompanyAnnualReportAdministrativeLicenseVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<DataCompanyAnnualReportAdministrativeLicenseVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<DataCompanyAnnualReportAdministrativeLicenseVO> queryDetail(CommonIdCommand detailCommand){
