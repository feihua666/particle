...
public interface IDataQueryDataApiRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<DataQueryDataApiVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<DataQueryDataApiVO> queryDetail(CommonIdCommand detailCommand);
