...
public class DataQueryDatasourceApiTestCommandExecutor extends AbstractBaseQueryExecutor {
	...
	public Object test(DataQueryDatasourceApiQueryCommand dataQueryDatasourceApiQueryCommand) {
		...
		Object query = datasourceApiQueryGateway.queryRealtime(dataQueryDatasource,
				dataQueryDatasourceApi,
				dataQueryDatasourceApiQueryCommand.getParam(),
				dataQueryDatasourceApiQueryCommand.getQueryString(),
				true);
