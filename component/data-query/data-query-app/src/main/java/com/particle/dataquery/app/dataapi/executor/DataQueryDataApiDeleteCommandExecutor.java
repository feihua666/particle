...
public class DataQueryDataApiDeleteCommandExecutor  extends AbstractBaseExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<DataQueryDataApiVO> execute(@Valid CommonIdCommand deleteCommand) {
		...
		boolean delete = dataQueryDataApiGateway.delete(dataQueryDataApiId,deleteCommand);
		if (delete) {
