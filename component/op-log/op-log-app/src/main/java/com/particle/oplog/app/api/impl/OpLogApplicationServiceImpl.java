...
import com.particle.oplog.app.executor.OpLogCreateCommandExecutor;
...
public class OpLogApplicationServiceImpl extends AbstractBaseApplicationServiceImpl implements IOpLogApplicationService {
    ...
    private OpLogCreateCommandExecutor opLogCreateCommandExecutor;

    private OpLogDeleteCommandExecutor opLogDeleteCommandExecutor;


    @Override
    public SingleResponse<OpLogVO> create(OpLogCreateCommand opLogCreateCommand) {
        return opLogCreateCommandExecutor.execute(opLogCreateCommand);
    }

    @Override
	public SingleResponse<OpLogVO> delete(CommonIdCommand deleteCommand) {
		return opLogDeleteCommandExecutor.execute(deleteCommand);
	}


    @Autowired
    public void setOpLogCreateCommandExecutor(OpLogCreateCommandExecutor opLogCreateCommandExecutor) {
		this.opLogCreateCommandExecutor = opLogCreateCommandExecutor;
	}
	@Autowired
