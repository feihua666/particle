...
public interface ITenantUserInviteUserRecordRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<TenantUserInviteUserRecordVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<TenantUserInviteUserRecordVO> queryDetail(CommonIdCommand detailCommand);
