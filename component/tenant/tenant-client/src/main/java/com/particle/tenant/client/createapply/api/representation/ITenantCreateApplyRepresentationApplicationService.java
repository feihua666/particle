...
public interface ITenantCreateApplyRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<TenantCreateApplyVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<TenantCreateApplyVO> queryDetail(CommonIdCommand detailCommand);
