...
CREATE TABLE `component_tenant` (
  ...
  `user_name` varchar(200) DEFAULT NULL COMMENT '姓名,主要用于联系人姓名',
  `email` varchar(300) DEFAULT NULL COMMENT '邮箱，联系邮箱',
  `mobile` varchar(255) DEFAULT NULL COMMENT '手机号，联系手机号',
