 ...
 */
@Api(tags = "租户用户邀请pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/tenant_user_invite")
public class TenantUserInviteFrontWebController extends AbstractBaseWebAdapter {
