-- 建表语句sql
DROP TABLE IF EXISTS component_crm_dept;
CREATE TABLE `component_crm_dept` (
  `id` bigint NOT NULL COMMENT 'id主键',
  `code` varchar(255) DEFAULT NULL COMMENT '部门编码',
  `name` varchar(100) NOT NULL COMMENT '部门名称',
  `crm_company_id` bigint NOT NULL COMMENT '客户公司id',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='客户公司部门表';
