-- 建表语句sql
DROP TABLE IF EXISTS component_crm_company;
CREATE TABLE `component_crm_company` (
  `id` bigint NOT NULL COMMENT 'id主键',
  `code` varchar(255) DEFAULT NULL COMMENT '公司编码',
  `name` varchar(100) NOT NULL COMMENT '公司名称',
  `name_simple` varchar(100) DEFAULT NULL COMMENT '公司简称名称',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='客户公司表';
