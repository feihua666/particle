...
public interface ICrmCompanyRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<CrmCompanyVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<CrmCompanyVO> queryDetail(CommonIdCommand detailCommand);
