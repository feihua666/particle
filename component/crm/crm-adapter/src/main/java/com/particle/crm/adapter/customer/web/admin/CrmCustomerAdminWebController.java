...
public class CrmCustomerAdminWebController extends AbstractBaseWebAdapter {
	...
	public SingleResponse<CrmCustomerVO> delete(@RequestBody CommonIdCommand deleteCommand){
	...
	public SingleResponse<CrmCustomerVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
	...
	@GetMapping("/detail")
	public SingleResponse<CrmCustomerVO> queryDetail(CommonIdCommand detailCommand){
