 ...
 */
@Tag(name = "客户联系方式wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/crm_customer_contact")
public class CrmCustomerContactAdminWapController extends AbstractBaseWapAdapter {
