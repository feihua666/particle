 ...
 *
 * @author yw
 * @since 2024-07-08 12:59:24
 */
@Tag(name = "客户翻译远程调用相关接口")
@RestController
@RequestMapping("/rpc/crm_customer")
public class CrmCustomerTransRpcController extends AbstractBaseRpcAdapter implements CrmCustomerTransRpcFeignClient {
