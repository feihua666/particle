...
public class CrmCustomerRelationDeleteCommandExecutor  extends AbstractBaseExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<CrmCustomerRelationVO> execute(@Valid CommonIdCommand deleteCommand) {
		...
		boolean delete = crmCustomerRelationGateway.delete(crmCustomerRelationId,deleteCommand);
		if (delete) {
