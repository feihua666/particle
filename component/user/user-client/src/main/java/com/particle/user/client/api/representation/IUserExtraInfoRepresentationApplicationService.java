...
public interface IUserExtraInfoRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<UserExtraInfoVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<UserExtraInfoVO> queryDetail(CommonIdCommand detailCommand);
