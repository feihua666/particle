 ...
 * @since 2022-11-26
 */
@Api(tags = "用户登录记录pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/user-login-record")
public class UserLoginRecordFrontWebController extends AbstractBaseWebAdapter {
