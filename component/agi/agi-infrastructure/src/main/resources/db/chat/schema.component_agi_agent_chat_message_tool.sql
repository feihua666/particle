-- 建表语句sql
DROP TABLE IF EXISTS component_agi_agent_chat_message_tool;
CREATE TABLE `component_agi_agent_chat_message_tool` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='智能体对话消息工具表';
