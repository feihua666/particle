...
CREATE TABLE `component_agi_agent` (
  ...
  `profile` varchar(1000) NOT NULL COMMENT '智能体简介',
  `role` text COMMENT '角色设定，描述人设与回复逻辑的文本',
  `is_use_prologue` tinyint(1) NOT NULL COMMENT '是否使用开场白',
  `prologue` varchar(1000) DEFAULT NULL COMMENT '开场白开场文案',
  `prologue_questions_json` varchar(1000) DEFAULT NULL COMMENT '开场白问题,这应该是一个包含问题的数组，一般填写2-3个',
  ...
  `auto_ask_rule` varchar(1000) DEFAULT NULL COMMENT '自动追问规则，描述追问的规则文本',
  `quick_instructions_json` varchar(1000) DEFAULT NULL COMMENT '快捷指令,预设的快速输入，内容是一个数组，数组项包含指令内容、图标等',
  ...
  `voice_json` varchar(1000) DEFAULT NULL COMMENT '声音配置，应该为一个对象，配置声音的音色等',
