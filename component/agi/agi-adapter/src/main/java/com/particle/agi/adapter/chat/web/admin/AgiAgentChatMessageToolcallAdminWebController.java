...
public class AgiAgentChatMessageToolcallAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<AgiAgentChatMessageToolcallVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<AgiAgentChatMessageToolcallVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<AgiAgentChatMessageToolcallVO> queryDetail(CommonIdCommand detailCommand){
