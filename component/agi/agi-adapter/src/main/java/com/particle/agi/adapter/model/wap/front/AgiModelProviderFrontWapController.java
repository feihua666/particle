 ...
 */
@Tag(name = "AI模型提供商wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/agi_model_provider")
public class AgiModelProviderFrontWapController extends AbstractBaseWapAdapter {
