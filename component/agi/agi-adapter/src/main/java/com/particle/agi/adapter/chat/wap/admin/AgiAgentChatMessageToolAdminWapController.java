 ...
 */
@Tag(name = "智能体对话消息工具wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/agi_agent_chat_message_tool")
public class AgiAgentChatMessageToolAdminWapController extends AbstractBaseWapAdapter {
