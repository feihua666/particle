 ...
 */
@Tag(name = "智能体对话消息媒体wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/agi_agent_chat_message_media")
public class AgiAgentChatMessageMediaAdminWapController extends AbstractBaseWapAdapter {
