 ...
 */
@Tag(name = "知识存储原始文档片段wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/agi_vector_store_raw_document_segment")
public class AgiVectorStoreRawDocumentSegmentFrontWapController extends AbstractBaseWapAdapter {
