 ...
 */
@Tag(name = "知识存储原始文档片段wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/agi_vector_store_raw_document_segment")
public class AgiVectorStoreRawDocumentSegmentAdminWapController extends AbstractBaseWapAdapter {
