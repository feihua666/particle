 ...
 */
@Tag(name = "智能体对话消息媒体移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/agi_agent_chat_message_media")
public class AgiAgentChatMessageMediaFrontMobileController extends AbstractBaseMobileAdapter {
