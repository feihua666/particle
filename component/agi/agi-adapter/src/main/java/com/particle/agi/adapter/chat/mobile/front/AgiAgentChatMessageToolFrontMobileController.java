 ...
 */
@Tag(name = "智能体对话消息工具移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/agi_agent_chat_message_tool")
public class AgiAgentChatMessageToolFrontMobileController extends AbstractBaseMobileAdapter {
