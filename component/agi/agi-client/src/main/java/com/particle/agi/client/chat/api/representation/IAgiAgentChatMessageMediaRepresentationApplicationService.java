...
public interface IAgiAgentChatMessageMediaRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<AgiAgentChatMessageMediaVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<AgiAgentChatMessageMediaVO> queryDetail(CommonIdCommand detailCommand);
