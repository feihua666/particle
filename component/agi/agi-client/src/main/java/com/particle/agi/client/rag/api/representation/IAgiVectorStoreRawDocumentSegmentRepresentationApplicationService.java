...
public interface IAgiVectorStoreRawDocumentSegmentRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<AgiVectorStoreRawDocumentSegmentVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<AgiVectorStoreRawDocumentSegmentVO> queryDetail(CommonIdCommand detailCommand);
