...
public interface IAgiAgentChatMessageRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<AgiAgentChatMessageVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<AgiAgentChatMessageVO> queryDetail(CommonIdCommand detailCommand);
