...
public interface IAgiAgentChatMessageToolcallRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<AgiAgentChatMessageToolcallVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<AgiAgentChatMessageToolcallVO> queryDetail(CommonIdCommand detailCommand);
