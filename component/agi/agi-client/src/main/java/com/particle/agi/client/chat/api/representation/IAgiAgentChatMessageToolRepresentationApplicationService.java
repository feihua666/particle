...
public interface IAgiAgentChatMessageToolRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<AgiAgentChatMessageToolVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<AgiAgentChatMessageToolVO> queryDetail(CommonIdCommand detailCommand);
