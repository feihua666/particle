 ...
 */
@Tag(name = "爬虫定义历史pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/crawler_definition_history")
public class CrawlerDefinitionHistoryFrontWebController extends AbstractBaseWebAdapter {
