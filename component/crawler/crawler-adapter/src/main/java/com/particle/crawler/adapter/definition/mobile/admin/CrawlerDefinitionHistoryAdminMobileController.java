 ...
 */
@Tag(name = "爬虫定义历史移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/crawler_definition_history")
public class CrawlerDefinitionHistoryAdminMobileController extends AbstractBaseMobileAdapter {
