 ...
 */
@Tag(name = "爬虫结构数据存储wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/crawler_data_store")
public class CrawlerDataStoreAdminWapController extends AbstractBaseWapAdapter {
