 ...
 */
@Tag(name = "爬虫结构数据存储移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/crawler_data_store")
public class CrawlerDataStoreFrontMobileController extends AbstractBaseMobileAdapter {
