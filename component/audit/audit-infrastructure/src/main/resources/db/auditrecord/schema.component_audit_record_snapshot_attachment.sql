-- 建表语句sql
DROP TABLE IF EXISTS component_audit_record_snapshot_attachment;
CREATE TABLE `component_audit_record_snapshot_attachment` (
  `id` bigint NOT NULL COMMENT '主键ID',
  `audit_record_id` bigint NOT NULL COMMENT '审核记录id',
  `data_id` bigint NOT NULL COMMENT '数据id，标识是哪个数据的附件',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='审核记录附件快照表';
