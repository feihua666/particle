...
@Data
@Schema
public class AuditRecordCreateCommand extends AbstractBaseCommand {
    ...
    @Schema(description = "快照数据,支持多个")
    private List<AuditRecordSnapshotDataCreateSimpleCommand> snapshotDataList;

    @Schema(description = "快照附件,支持多个")
    private List<AuditRecordSnapshotAttachmentCreateSimpleCommand> snapshotAttachmentList;
