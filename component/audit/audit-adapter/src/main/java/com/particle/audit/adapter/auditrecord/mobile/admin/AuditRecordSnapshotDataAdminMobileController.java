 ...
 */
@Tag(name = "审核记录数据快照移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/audit_record_snapshot_data")
public class AuditRecordSnapshotDataAdminMobileController extends AbstractBaseMobileAdapter {
