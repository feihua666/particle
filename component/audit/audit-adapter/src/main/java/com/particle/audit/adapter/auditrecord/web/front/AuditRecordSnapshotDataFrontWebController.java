 ...
 */
@Tag(name = "审核记录数据快照pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/audit_record_snapshot_data")
public class AuditRecordSnapshotDataFrontWebController extends AbstractBaseWebAdapter {
