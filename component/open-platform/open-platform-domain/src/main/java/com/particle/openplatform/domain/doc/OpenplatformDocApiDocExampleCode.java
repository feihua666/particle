...
@Data
@Entity
public class OpenplatformDocApiDocExampleCode extends AggreateRoot {

    private OpenplatformDocApiDocExampleCodeId id;
    ...
    */
    ...
    /**
     * 创建开放接口文档示例代码领域模型对象
     * @return 开放接口文档示例代码领域模型对象，该对应所有属性为空，需要进行初始化操作
     */
    public static OpenplatformDocApiDocExampleCode create(){
        return DomainFactory.create(OpenplatformDocApiDocExampleCode.class);
    }
}