 ...
 */
public interface OpenplatformOpenapiBatchQueryRecordDetailGateway extends IBaseGateway<OpenplatformOpenapiBatchQueryRecordDetailId,OpenplatformOpenapiBatchQueryRecordDetail> {
}
