...
@Data
@Entity
public class OpenplatformDocApiDocParamField extends AggreateRoot {

    private OpenplatformDocApiDocParamFieldId id;
    ...
    */
    ...
    /**
     * 创建开放接口文档参数字段领域模型对象
     * @return 开放接口文档参数字段领域模型对象，该对应所有属性为空，需要进行初始化操作
     */
    public static OpenplatformDocApiDocParamField create(){
        return DomainFactory.create(OpenplatformDocApiDocParamField.class);
    }
}