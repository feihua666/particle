-- 建表语句sql
DROP TABLE IF EXISTS component_openplatform_openapi_record_app_openapi_month_summary;
CREATE TABLE `component_openplatform_openapi_record_app_openapi_month_summary` (
  ...
  UNIQUE KEY `uni_openplatform_app_id_app_id_openplatform_openapi_id_y_m` (`openplatform_app_id`,`app_id`,`openplatform_openapi_id`,`year`,`month`) USING BTREE,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='开放平台应用开放接口月汇总表';
