-- 建表语句sql
DROP TABLE IF EXISTS component_openplatform_provider_record_prd_month_bill;
CREATE TABLE `component_openplatform_provider_record_prd_month_bill` (
  ...
  UNIQUE KEY `uni_openplatform_provider_id_y_m` (`openplatform_provider_id`,`year`,`month`) USING BTREE,
