-- 建表语句sql
DROP TABLE IF EXISTS component_openplatform_openapi_record_customer_month_bill;
CREATE TABLE `component_openplatform_openapi_record_customer_month_bill` (
  ...
  UNIQUE KEY `uni_customer_id_year_month` (`customer_id`,`year`,`month`) USING BTREE,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='开放平台客户月账单表';
