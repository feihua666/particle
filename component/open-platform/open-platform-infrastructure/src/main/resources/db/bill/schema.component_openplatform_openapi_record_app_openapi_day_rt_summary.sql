-- 建表语句sql
DROP TABLE IF EXISTS component_openplatform_openapi_record_app_openapi_day_rt_summary;
CREATE TABLE `component_openplatform_openapi_record_app_openapi_day_rt_summary` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='开放平台应用开放接口日实时汇总表';
