-- 建表语句sql
DROP TABLE IF EXISTS component_openplatform_doc_api_doc_template_param_field;
CREATE TABLE `component_openplatform_doc_api_doc_template_param_field` (
  ...
  `dict_group_dict_id` bigint NOT NULL COMMENT '字典组字典，字典组id，字典组下面的字典项为字段枚举',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='开放接口文档模板参数字段表';
