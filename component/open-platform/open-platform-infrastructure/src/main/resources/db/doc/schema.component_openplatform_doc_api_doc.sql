...
CREATE TABLE `component_openplatform_doc_api_doc` (
  ...
  `request_url_prefix` varchar(300) COLLATE utf8_bin DEFAULT NULL COMMENT '请求地址前缀，可全局配置',
  `request_url` varchar(300) COLLATE utf8_bin NOT NULL COMMENT '请求地址',
  ...
  `response_max_duration_desc` int DEFAULT NULL COMMENT '响应时长文本，response_max_duration不支持时作为备用',
  `authentication_type` varchar(2000) COLLATE utf8_bin DEFAULT NULL COMMENT '认证方式',
  `description_detail` text COLLATE utf8_bin COMMENT '详细描述，详细描述文档内容或返回参数信息',
  `request_param_example` varchar(2000) COLLATE utf8_bin NOT NULL COMMENT '请求参数示例',
  `response_param_example` longtext COLLATE utf8_bin NOT NULL COMMENT '响应参数示例',
