-- 建表语句sql
DROP TABLE IF EXISTS component_openplatform_doc_api_doc_example_code;
CREATE TABLE `component_openplatform_doc_api_doc_example_code` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='开放接口文档示例代码表';
