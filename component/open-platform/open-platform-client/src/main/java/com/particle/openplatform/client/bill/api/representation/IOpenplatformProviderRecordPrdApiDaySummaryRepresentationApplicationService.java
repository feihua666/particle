...
public interface IOpenplatformProviderRecordPrdApiDaySummaryRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformProviderRecordPrdApiDaySummaryVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformProviderRecordPrdApiDaySummaryVO> queryDetail(CommonIdCommand detailCommand);
