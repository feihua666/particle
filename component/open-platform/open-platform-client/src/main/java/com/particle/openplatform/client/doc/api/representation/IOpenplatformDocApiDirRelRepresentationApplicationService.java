...
public interface IOpenplatformDocApiDirRelRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDirRelVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDirRelVO> queryDetail(CommonIdCommand detailCommand);
