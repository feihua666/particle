...
public interface IOpenplatformDocApiDocResponseCodeRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDocResponseCodeVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDocResponseCodeVO> queryDetail(CommonIdCommand detailCommand);
