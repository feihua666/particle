...
public interface IOpenplatformOpenapiRecordAppMonthBillRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiRecordAppMonthBillVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiRecordAppMonthBillVO> queryDetail(CommonIdCommand detailCommand);
