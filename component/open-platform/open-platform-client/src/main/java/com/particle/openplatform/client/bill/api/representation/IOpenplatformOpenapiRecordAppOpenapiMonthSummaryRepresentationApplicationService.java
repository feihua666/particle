...
public interface IOpenplatformOpenapiRecordAppOpenapiMonthSummaryRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiRecordAppOpenapiMonthSummaryVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiRecordAppOpenapiMonthSummaryVO> queryDetail(CommonIdCommand detailCommand);
