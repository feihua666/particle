...
public interface IOpenplatformDocApiDocTemplateParamFieldRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDocTemplateParamFieldVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDocTemplateParamFieldVO> queryDetail(CommonIdCommand detailCommand);
