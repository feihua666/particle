...
public interface IOpenplatformOpenapiFeeRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiFeeVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiFeeVO> queryDetail(CommonIdCommand detailCommand);
