...
public interface IOpenplatformAppOpenapiRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformAppOpenapiVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformAppOpenapiVO> queryDetail(CommonIdCommand detailCommand);
