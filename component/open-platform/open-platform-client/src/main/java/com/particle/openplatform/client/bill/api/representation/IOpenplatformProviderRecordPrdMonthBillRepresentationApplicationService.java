...
public interface IOpenplatformProviderRecordPrdMonthBillRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformProviderRecordPrdMonthBillVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformProviderRecordPrdMonthBillVO> queryDetail(CommonIdCommand detailCommand);
