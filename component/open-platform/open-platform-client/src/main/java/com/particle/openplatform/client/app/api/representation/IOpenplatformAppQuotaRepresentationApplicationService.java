...
public interface IOpenplatformAppQuotaRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformAppQuotaVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformAppQuotaVO> queryDetail(CommonIdCommand detailCommand);
