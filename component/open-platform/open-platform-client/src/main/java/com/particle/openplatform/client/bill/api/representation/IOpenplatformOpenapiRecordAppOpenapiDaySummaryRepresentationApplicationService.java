...
public interface IOpenplatformOpenapiRecordAppOpenapiDaySummaryRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiRecordAppOpenapiDaySummaryVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiRecordAppOpenapiDaySummaryVO> queryDetail(CommonIdCommand detailCommand);
