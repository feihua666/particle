...
public interface IOpenplatformDocApiDocTemplateRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDocTemplateVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDocTemplateVO> queryDetail(CommonIdCommand detailCommand);
