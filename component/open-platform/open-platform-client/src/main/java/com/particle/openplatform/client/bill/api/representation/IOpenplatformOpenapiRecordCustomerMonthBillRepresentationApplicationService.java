...
public interface IOpenplatformOpenapiRecordCustomerMonthBillRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiRecordCustomerMonthBillVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiRecordCustomerMonthBillVO> queryDetail(CommonIdCommand detailCommand);
