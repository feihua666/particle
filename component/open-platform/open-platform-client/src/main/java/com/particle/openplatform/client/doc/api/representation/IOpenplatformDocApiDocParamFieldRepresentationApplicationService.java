...
public interface IOpenplatformDocApiDocParamFieldRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDocParamFieldVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDocParamFieldVO> queryDetail(CommonIdCommand detailCommand);
