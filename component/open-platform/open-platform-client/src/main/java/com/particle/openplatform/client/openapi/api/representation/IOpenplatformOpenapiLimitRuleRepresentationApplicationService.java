...
public interface IOpenplatformOpenapiLimitRuleRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiLimitRuleVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiLimitRuleVO> queryDetail(CommonIdCommand detailCommand);
