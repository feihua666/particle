...
public interface IOpenplatformProviderApiRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformProviderApiVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformProviderApiVO> queryDetail(CommonIdCommand detailCommand);
