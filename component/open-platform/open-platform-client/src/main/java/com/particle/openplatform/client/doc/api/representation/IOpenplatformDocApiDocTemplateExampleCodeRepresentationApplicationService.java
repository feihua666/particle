...
public interface IOpenplatformDocApiDocTemplateExampleCodeRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDocTemplateExampleCodeVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDocTemplateExampleCodeVO> queryDetail(CommonIdCommand detailCommand);
