...
public interface IOpenplatformProviderRecordPrdApiMonthSummaryRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformProviderRecordPrdApiMonthSummaryVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformProviderRecordPrdApiMonthSummaryVO> queryDetail(CommonIdCommand detailCommand);
