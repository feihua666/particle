...
public interface IOpenplatformDocApiDocExampleCodeRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDocExampleCodeVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformDocApiDocExampleCodeVO> queryDetail(CommonIdCommand detailCommand);
