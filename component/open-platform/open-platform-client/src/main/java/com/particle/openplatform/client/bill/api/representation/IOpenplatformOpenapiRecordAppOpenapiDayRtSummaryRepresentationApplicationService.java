...
public interface IOpenplatformOpenapiRecordAppOpenapiDayRtSummaryRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiRecordAppOpenapiDayRtSummaryVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiRecordAppOpenapiDayRtSummaryVO> queryDetail(CommonIdCommand detailCommand);
