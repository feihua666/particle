...
public interface IOpenplatformOpenapiBatchQueryRecordRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiBatchQueryRecordVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<OpenplatformOpenapiBatchQueryRecordVO> queryDetail(CommonIdCommand detailCommand);
