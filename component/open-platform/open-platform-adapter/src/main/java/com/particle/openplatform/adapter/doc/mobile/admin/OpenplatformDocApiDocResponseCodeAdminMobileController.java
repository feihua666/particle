 ...
 */
@Tag(name = "开放接口文档响应码移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/openplatform_doc_api_doc_response_code")
public class OpenplatformDocApiDocResponseCodeAdminMobileController extends AbstractBaseMobileAdapter {
