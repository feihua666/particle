 ...
 */
@Tag(name = "开放接口文档接口与目录关系pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/openplatform_doc_api_dir_rel")
public class OpenplatformDocApiDirRelFrontWebController extends AbstractBaseWebAdapter {
