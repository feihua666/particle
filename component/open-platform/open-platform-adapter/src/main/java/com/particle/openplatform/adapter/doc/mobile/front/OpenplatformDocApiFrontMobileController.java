 ...
 */
@Tag(name = "开放接口文档接口移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/openplatform_doc_api")
public class OpenplatformDocApiFrontMobileController extends AbstractBaseMobileAdapter {
