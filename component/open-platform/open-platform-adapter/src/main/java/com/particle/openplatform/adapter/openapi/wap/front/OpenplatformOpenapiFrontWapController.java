 ...
 */
@Tag(name = "开放平台开放接口wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/openplatform_openapi")
public class OpenplatformOpenapiFrontWapController extends AbstractBaseWapAdapter {
