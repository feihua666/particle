 ...
 */
@Tag(name = "开放接口文档响应码wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/openplatform_doc_api_doc_response_code")
public class OpenplatformDocApiDocResponseCodeAdminWapController extends AbstractBaseWapAdapter {
