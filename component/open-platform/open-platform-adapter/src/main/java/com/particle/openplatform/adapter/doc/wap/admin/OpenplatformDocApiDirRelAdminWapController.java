 ...
 */
@Tag(name = "开放接口文档接口与目录关系wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/openplatform_doc_api_dir_rel")
public class OpenplatformDocApiDirRelAdminWapController extends AbstractBaseWapAdapter {
