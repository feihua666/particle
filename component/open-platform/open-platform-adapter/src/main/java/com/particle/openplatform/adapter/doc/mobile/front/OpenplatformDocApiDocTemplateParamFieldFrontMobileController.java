 ...
 */
@Tag(name = "开放接口文档模板参数字段移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/openplatform_doc_api_doc_template_param_field")
public class OpenplatformDocApiDocTemplateParamFieldFrontMobileController extends AbstractBaseMobileAdapter {
