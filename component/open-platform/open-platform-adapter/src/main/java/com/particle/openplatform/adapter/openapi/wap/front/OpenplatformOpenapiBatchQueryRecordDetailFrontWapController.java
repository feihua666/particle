 ...
 */
@Tag(name = "开放接口批量查询记录明细wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/openplatform_openapi_batch_query_record_detail")
public class OpenplatformOpenapiBatchQueryRecordDetailFrontWapController extends AbstractBaseWapAdapter {
