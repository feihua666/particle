 ...
 */
@Tag(name = "开放接口文档示例代码pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/openplatform_doc_api_doc_example_code")
public class OpenplatformDocApiDocExampleCodeFrontWebController extends AbstractBaseWebAdapter {
