 ...
 */
@Tag(name = "开放接口文档接口与目录关系移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/openplatform_doc_api_dir_rel")
public class OpenplatformDocApiDirRelFrontMobileController extends AbstractBaseMobileAdapter {
