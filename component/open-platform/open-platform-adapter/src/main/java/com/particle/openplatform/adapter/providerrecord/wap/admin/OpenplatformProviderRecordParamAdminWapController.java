...
/**
 * <p>
 * 开放平台开放接口供应商调用记录参数后台管理wap端前端适配器
 * 主要用于wap端后台管理
 * </p>
 *
 * @author yw
 ...
 */
@Tag(name = "开放平台开放接口供应商调用记录参数wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/openplatform_provider_record_param")
public class OpenplatformProviderRecordParamAdminWapController extends AbstractBaseWapAdapter {
