 ...
 */
@Tag(name = "开放接口批量查询记录wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/openplatform_openapi_batch_query_record")
public class OpenplatformOpenapiBatchQueryRecordFrontWapController extends AbstractBaseWapAdapter {
