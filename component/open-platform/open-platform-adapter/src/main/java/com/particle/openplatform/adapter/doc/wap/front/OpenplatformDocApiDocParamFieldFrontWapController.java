 ...
 */
@Tag(name = "开放接口文档参数字段wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/openplatform_doc_api_doc_param_field")
public class OpenplatformDocApiDocParamFieldFrontWapController extends AbstractBaseWapAdapter {
