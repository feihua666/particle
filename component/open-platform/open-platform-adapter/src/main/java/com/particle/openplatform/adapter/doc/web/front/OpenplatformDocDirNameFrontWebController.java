 ...
 */
@Tag(name = "开放接口目录名称pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/openplatform_doc_dir_name")
public class OpenplatformDocDirNameFrontWebController extends AbstractBaseWebAdapter {
