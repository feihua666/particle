 ...
 */
@Tag(name = "开放接口文档示例代码wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/openplatform_doc_api_doc_example_code")
public class OpenplatformDocApiDocExampleCodeAdminWapController extends AbstractBaseWapAdapter {
