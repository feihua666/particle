 ...
 */
@Tag(name = "开放平台开放接口调用记录参数wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/openplatform_openapi_record_param")
public class OpenplatformOpenapiRecordParamFrontWapController extends AbstractBaseWapAdapter {
