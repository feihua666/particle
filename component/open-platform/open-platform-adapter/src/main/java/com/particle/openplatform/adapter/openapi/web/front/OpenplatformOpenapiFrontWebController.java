 ...
 */
@Tag(name = "开放平台开放接口pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/openplatform_openapi")
public class OpenplatformOpenapiFrontWebController extends AbstractBaseWebAdapter {
