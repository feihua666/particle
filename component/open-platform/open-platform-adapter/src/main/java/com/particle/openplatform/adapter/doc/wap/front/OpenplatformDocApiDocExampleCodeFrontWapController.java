 ...
 */
@Tag(name = "开放接口文档示例代码wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/openplatform_doc_api_doc_example_code")
public class OpenplatformDocApiDocExampleCodeFrontWapController extends AbstractBaseWapAdapter {
