...
public class OpenplatformAppAdminWebController extends AbstractBaseWebAdapter {
	...
	public SingleResponse<OpenplatformAppVO> delete(@RequestBody CommonIdCommand deleteCommand){
	...
	public SingleResponse<OpenplatformAppVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
	...
	@GetMapping("/detail")
	public SingleResponse<OpenplatformAppVO> queryDetail(CommonIdCommand detailCommand){
