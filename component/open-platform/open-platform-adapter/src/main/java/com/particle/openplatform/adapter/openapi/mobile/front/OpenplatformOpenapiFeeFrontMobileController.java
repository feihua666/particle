 ...
 */
@Tag(name = "开放平台开放接口费用移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/openplatform_openapi_fee")
public class OpenplatformOpenapiFeeFrontMobileController extends AbstractBaseMobileAdapter {
