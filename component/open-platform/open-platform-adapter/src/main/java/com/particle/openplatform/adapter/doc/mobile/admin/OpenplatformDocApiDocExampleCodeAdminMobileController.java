 ...
 */
@Tag(name = "开放接口文档示例代码移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/openplatform_doc_api_doc_example_code")
public class OpenplatformDocApiDocExampleCodeAdminMobileController extends AbstractBaseMobileAdapter {
