 ...
 */
@Tag(name = "开放接口文档参数字段移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/openplatform_doc_api_doc_param_field")
public class OpenplatformDocApiDocParamFieldFrontMobileController extends AbstractBaseMobileAdapter {
