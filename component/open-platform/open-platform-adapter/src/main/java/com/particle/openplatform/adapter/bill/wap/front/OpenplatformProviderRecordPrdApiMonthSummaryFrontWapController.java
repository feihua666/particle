 ...
 */
@Tag(name = "开放平台供应商接口月汇总wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/openplatform_provider_record_prd_api_month_summary")
public class OpenplatformProviderRecordPrdApiMonthSummaryFrontWapController extends AbstractBaseWapAdapter {
