 ...
 */
@Tag(name = "开放平台开放接口调用记录移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/openplatform_openapi_record")
public class OpenplatformOpenapiRecordAdminMobileController extends AbstractBaseMobileAdapter {
