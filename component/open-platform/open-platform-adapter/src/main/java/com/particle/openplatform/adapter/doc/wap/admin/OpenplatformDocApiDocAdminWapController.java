 ...
 */
@Tag(name = "开放接口文档wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/openplatform_doc_api_doc")
public class OpenplatformDocApiDocAdminWapController extends AbstractBaseWapAdapter {
