 ...
 */
@Tag(name = "开放平台应用开放接口日汇总wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/openplatform_openapi_record_app_openapi_day_summary")
public class OpenplatformOpenapiRecordAppOpenapiDaySummaryFrontWapController extends AbstractBaseWapAdapter {
