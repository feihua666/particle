 ...
 */
@Tag(name = "开放接口目录名称移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/openplatform_doc_dir_name")
public class OpenplatformDocDirNameFrontMobileController extends AbstractBaseMobileAdapter {
