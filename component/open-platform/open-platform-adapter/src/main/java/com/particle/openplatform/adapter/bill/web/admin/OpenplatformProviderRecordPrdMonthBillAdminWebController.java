...
public class OpenplatformProviderRecordPrdMonthBillAdminWebController extends AbstractBaseWebAdapter {
    ...
    @PostMapping("/create")
    @OpLog(name = "添加开放平台供应商月账单",module = OpLogConstants.Module.openPlatform,type = OpLogConstants.Type.create)
    ...
    @OpLog(name = "删除开放平台供应商月账单",module = OpLogConstants.Module.openPlatform,type = OpLogConstants.Type.delete)
    public SingleResponse<OpenplatformProviderRecordPrdMonthBillVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    @PutMapping("/update")
    @OpLog(name = "更新开放平台供应商月账单",module = OpLogConstants.Module.openPlatform,type = OpLogConstants.Type.update)
    ...
    public SingleResponse<OpenplatformProviderRecordPrdMonthBillVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<OpenplatformProviderRecordPrdMonthBillVO> queryDetail(CommonIdCommand detailCommand){
