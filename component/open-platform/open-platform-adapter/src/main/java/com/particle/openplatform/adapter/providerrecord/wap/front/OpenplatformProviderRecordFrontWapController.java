 ...
 */
@Tag(name = "开放平台开放接口供应商调用记录wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/openplatform_provider_record")
public class OpenplatformProviderRecordFrontWapController extends AbstractBaseWapAdapter {
