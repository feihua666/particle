 ...
 */
@Tag(name = "开放平台供应商月账单pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/openplatform_provider_record_prd_month_bill")
public class OpenplatformProviderRecordPrdMonthBillFrontWebController extends AbstractBaseWebAdapter {
