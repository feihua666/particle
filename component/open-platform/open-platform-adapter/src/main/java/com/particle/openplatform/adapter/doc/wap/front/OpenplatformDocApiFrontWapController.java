 ...
 */
@Tag(name = "开放接口文档接口wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/openplatform_doc_api")
public class OpenplatformDocApiFrontWapController extends AbstractBaseWapAdapter {
