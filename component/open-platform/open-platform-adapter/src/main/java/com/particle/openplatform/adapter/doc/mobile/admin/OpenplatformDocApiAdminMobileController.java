 ...
 */
@Tag(name = "开放接口文档接口移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/openplatform_doc_api")
public class OpenplatformDocApiAdminMobileController extends AbstractBaseMobileAdapter {
