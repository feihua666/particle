 ...
 */
@Tag(name = "开放接口文档响应码pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/openplatform_doc_api_doc_response_code")
public class OpenplatformDocApiDocResponseCodeFrontWebController extends AbstractBaseWebAdapter {
