 ...
 */
@Tag(name = "开放接口文档模板响应码移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/openplatform_doc_api_doc_template_response_code")
public class OpenplatformDocApiDocTemplateResponseCodeFrontMobileController extends AbstractBaseMobileAdapter {
