 ...
 */
@Tag(name = "开放平台供应商接口日汇总pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/openplatform_provider_record_prd_api_day_summary")
public class OpenplatformProviderRecordPrdApiDaySummaryFrontWebController extends AbstractBaseWebAdapter {
