...
public class OpenplatformDocApiDocExampleCodeDeleteCommandExecutor  extends AbstractBaseExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<OpenplatformDocApiDocExampleCodeVO> execute(@Valid CommonIdCommand deleteCommand) {
		...
		boolean delete = openplatformDocApiDocExampleCodeGateway.delete(openplatformDocApiDocExampleCodeId,deleteCommand);
		if (delete) {
