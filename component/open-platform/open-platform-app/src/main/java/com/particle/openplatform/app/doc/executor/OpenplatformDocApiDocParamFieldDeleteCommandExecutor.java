...
public class OpenplatformDocApiDocParamFieldDeleteCommandExecutor  extends AbstractBaseExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<OpenplatformDocApiDocParamFieldVO> execute(@Valid CommonIdCommand deleteCommand) {
		...
		boolean delete = openplatformDocApiDocParamFieldGateway.delete(openplatformDocApiDocParamFieldId,deleteCommand);
		if (delete) {
