...
public class OpenplatformDocApiDocTemplateResponseCodeDeleteCommandExecutor  extends AbstractBaseExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<OpenplatformDocApiDocTemplateResponseCodeVO> execute(@Valid CommonIdCommand deleteCommand) {
		...
		boolean delete = openplatformDocApiDocTemplateResponseCodeGateway.delete(openplatformDocApiDocTemplateResponseCodeId,deleteCommand);
		if (delete) {
