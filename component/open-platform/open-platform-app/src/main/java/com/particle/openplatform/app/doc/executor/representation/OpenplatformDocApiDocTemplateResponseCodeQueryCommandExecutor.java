...
public class OpenplatformDocApiDocTemplateResponseCodeQueryCommandExecutor  extends AbstractBaseQueryExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<OpenplatformDocApiDocTemplateResponseCodeVO> executeDetail(CommonIdCommand detailCommand) {
	 ...
	 * @return
	 */
	public SingleResponse<OpenplatformDocApiDocTemplateResponseCodeVO> executeDetailForUpdate(CommonIdCommand detailForUpdateCommand) {
