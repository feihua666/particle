...
public interface IMessageTemplateRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<MessageTemplateVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<MessageTemplateVO> queryDetail(CommonIdCommand detailCommand);
