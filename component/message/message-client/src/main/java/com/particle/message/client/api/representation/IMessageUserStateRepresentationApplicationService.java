...
public interface IMessageUserStateRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<MessageUserStateVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<MessageUserStateVO> queryDetail(CommonIdCommand detailCommand);
