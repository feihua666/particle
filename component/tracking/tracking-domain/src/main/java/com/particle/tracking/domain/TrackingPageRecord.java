...
@Data
@Entity
public class TrackingPageRecord extends AggreateRoot {

    private TrackingPageRecordId id;
    ...
    */
    ...
    /**
     * 创建页面埋点记录领域模型对象
     * @return 页面埋点记录领域模型对象，该对应所有属性为空，需要进行初始化操作
     */
    public static TrackingPageRecord create(){
        return DomainFactory.create(TrackingPageRecord.class);
    }
}
