 ...
 */
@Tag(name = "页面埋点记录wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/tracking_page_record")
public class TrackingPageRecordFrontWapController extends AbstractBaseWapAdapter {
