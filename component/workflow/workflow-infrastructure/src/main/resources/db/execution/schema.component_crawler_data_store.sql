-- 建表语句sql
DROP TABLE IF EXISTS component_crawler_data_store;
CREATE TABLE `component_crawler_data_store` (
  `id` bigint NOT NULL COMMENT '主键ID',
  `crawler_raw_store_id` bigint DEFAULT NULL COMMENT '爬虫原始数据存储ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='爬虫结构数据存储表';
