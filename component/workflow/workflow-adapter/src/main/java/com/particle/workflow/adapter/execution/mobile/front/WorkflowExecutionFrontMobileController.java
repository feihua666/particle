 ...
 */
@Tag(name = "工作流执行实例移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/workflow_execution")
public class WorkflowExecutionFrontMobileController extends AbstractBaseMobileAdapter {
