 ...
 */
@Tag(name = "工作流节点执行实例wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/workflow_execution_node")
public class WorkflowExecutionNodeFrontWapController extends AbstractBaseWapAdapter {
