 ...
 */
@Tag(name = "工作流项目移动端后台管理相关接口")
@RestController
@RequestMapping("/admin/mobile/workflow_project")
public class WorkflowProjectAdminMobileController extends AbstractBaseMobileAdapter {
