 ...
 */
@Tag(name = "工作流执行实例wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/workflow_execution")
public class WorkflowExecutionAdminWapController extends AbstractBaseWapAdapter {
