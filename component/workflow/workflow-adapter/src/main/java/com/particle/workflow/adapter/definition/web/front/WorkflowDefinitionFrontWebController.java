 ...
 */
@Tag(name = "工作流定义pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/workflow_definition")
public class WorkflowDefinitionFrontWebController extends AbstractBaseWebAdapter {
