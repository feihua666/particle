...
@Data
@Entity
public class WorkflowProject extends AggreateRoot {

    private WorkflowProjectId id;
    ...
    */
    ...
    /**
     * 创建工作流项目领域模型对象
     * @return 工作流项目领域模型对象，该对应所有属性为空，需要进行初始化操作
     */
    public static WorkflowProject create(){
        return DomainFactory.create(WorkflowProject.class);
    }
}
