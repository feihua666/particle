...
public class SystemConfigLogoResolver implements LogoFilter.LogoResolver {
    ...
    public LogoFilter.LogoResolveResult resolve(HttpServletRequest request) {
        ...
        MultiResponse<SystemConfigVO> systemConfigVOSingleResponse = systemConfigRpcFeignClient.queryByTag(SYSTEM_LOGO,false);
        ...
        return LogoFilter.resolveByAmbiguousString(value,"system logo");
    }
}
