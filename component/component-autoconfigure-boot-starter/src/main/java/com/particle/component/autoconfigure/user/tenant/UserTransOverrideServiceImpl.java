...
public class UserTransOverrideServiceImpl implements UserTransOverrideService {
	...
	public List<UserTransOverrideDTO> getOverrideData(List<Long> userIds) {
        CommonBatchIdCommand commonBatchIdCommand = CommonBatchIdCommand.create(userIds);
        MultiResponse<TenantUserVO> tenantUserVOMultiResponse = tenantUserRpcFeignClient.queryListByUserIds(commonBatchIdCommand);
