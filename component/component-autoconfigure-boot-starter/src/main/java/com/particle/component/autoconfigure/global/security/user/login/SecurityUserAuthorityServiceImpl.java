...
import com.particle.role.client.dto.command.representation.RoleQueryListByUserCommonIdCommand;
 ...
 */
public class SecurityUserAuthorityServiceImpl implements SecurityUserAuthorityService {
    ...
    private  List<UserGrantedAuthority> retrieveRoleUserGrantedAuthorityByUserId(LoginUser loginUser) {
        RoleQueryListByUserCommonIdCommand roleQueryListByUserIdCommand = new RoleQueryListByUserCommonIdCommand();
        ...
        for (RoleVO roleVO : roleVOS) {
            ...
            userGrantedAuthorities.add(userGrantedAuthority);
        }
        ...
        return userFuncRetrieve.retrieveRoleUserGrantedAuthorityByRoles(userGrantedAuthorities,loginUser);
    }
}
