...
public interface IReportReportApiRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<ReportReportApiVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<ReportReportApiVO> queryDetail(CommonIdCommand detailCommand);
