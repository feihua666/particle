 ...
 * <p>
 * 报告服务接口
 * 基础路径 {@link ReportApiController#API_REQUEST_MAPPING} 中 re 表示 report 的缩写，为了缩短路径
 * </p>
 *
 * @author yw
 * @since 2023-09-07 11:14:56
 */
@Tag(name = "报告服务接口")
@RestController
@RequestMapping(ReportApiController.API_REQUEST_MAPPING)
public class ReportApiController extends AbstractBaseApiAdapter {
	public static final String API_REQUEST_MAPPING = "/api/re";
