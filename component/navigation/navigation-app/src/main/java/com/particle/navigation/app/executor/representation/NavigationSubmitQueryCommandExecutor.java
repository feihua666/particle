...
public class NavigationSubmitQueryCommandExecutor  extends AbstractBaseQueryExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<NavigationSubmitVO> executeDetail(CommonIdCommand detailCommand) {
	 ...
	 * @return
	 */
	public SingleResponse<NavigationSubmitVO> executeDetailForUpdate(CommonIdCommand detailForUpdateCommand) {
