 ...
 */
@Tag(name = "导航网站分类关系wap端前台应用相关接口")
@RestController
@RequestMapping("/front/wap/navigation_site_category_rel")
public class NavigationSiteCategoryRelFrontWapController extends AbstractBaseWapAdapter {
