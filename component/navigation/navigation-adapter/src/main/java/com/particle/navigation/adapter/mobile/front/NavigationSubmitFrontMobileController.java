 ...
 */
@Tag(name = "导航提交移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/navigation_submit")
public class NavigationSubmitFrontMobileController extends AbstractBaseMobileAdapter {
