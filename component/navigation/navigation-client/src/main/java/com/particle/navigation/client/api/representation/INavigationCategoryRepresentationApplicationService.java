...
public interface INavigationCategoryRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<NavigationCategoryVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<NavigationCategoryVO> queryDetail(CommonIdCommand detailCommand);
