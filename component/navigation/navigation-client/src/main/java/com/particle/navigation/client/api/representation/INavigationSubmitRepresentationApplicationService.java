...
public interface INavigationSubmitRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<NavigationSubmitVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<NavigationSubmitVO> queryDetail(CommonIdCommand detailCommand);
