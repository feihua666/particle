...
public interface INavigationFriendshipLinkRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<NavigationFriendshipLinkVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<NavigationFriendshipLinkVO> queryDetail(CommonIdCommand detailCommand);
