...
public interface INavigationSiteTagRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<NavigationSiteTagVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<NavigationSiteTagVO> queryDetail(CommonIdCommand detailCommand);
