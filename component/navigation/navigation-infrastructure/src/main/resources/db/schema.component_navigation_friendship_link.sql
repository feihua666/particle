-- 建表语句sql
DROP TABLE IF EXISTS component_navigation_friendship_link;
CREATE TABLE `component_navigation_friendship_link` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='导航友情链接表';
