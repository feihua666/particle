...
public class LowcodeModelItemDeleteCommandExecutor  extends AbstractBaseExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<LowcodeModelItemVO> execute(@Valid CommonIdCommand deleteCommand) {
		...
		boolean delete = lowcodeModelItemGateway.delete(lowcodeModelItemId,deleteCommand);
		if (delete) {
