...
public interface ILowcodeModelItemRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<LowcodeModelItemVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<LowcodeModelItemVO> queryDetail(CommonIdCommand detailCommand);
