...
public interface ILowcodeModelRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<LowcodeModelVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<LowcodeModelVO> queryDetail(CommonIdCommand detailCommand);
