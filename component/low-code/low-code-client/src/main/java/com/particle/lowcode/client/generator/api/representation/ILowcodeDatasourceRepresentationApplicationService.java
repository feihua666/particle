...
public interface ILowcodeDatasourceRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<LowcodeDatasourceVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<LowcodeDatasourceVO> queryDetail(CommonIdCommand detailCommand);
