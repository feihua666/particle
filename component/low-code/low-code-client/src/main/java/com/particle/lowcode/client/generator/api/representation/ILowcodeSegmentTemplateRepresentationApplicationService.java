...
public interface ILowcodeSegmentTemplateRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<LowcodeSegmentTemplateVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<LowcodeSegmentTemplateVO> queryDetail(CommonIdCommand detailCommand);
