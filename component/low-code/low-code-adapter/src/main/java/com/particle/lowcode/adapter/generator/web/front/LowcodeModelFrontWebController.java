 ...
 * @since 2023-01-05
 */
@Api(tags = "低代码模型pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/lowcode-model")
public class LowcodeModelFrontWebController extends AbstractBaseWebAdapter {
