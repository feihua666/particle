 ...
 */
@Tag(name = "使用次数记录明细pc或平板端前台应用相关接口")
@RestController
@RequestMapping("/front/web/usage_count_record_detail")
public class UsageCountRecordDetailFrontWebController extends AbstractBaseWebAdapter {
