...
public class UsageCountDefineDeleteCommandExecutor  extends AbstractBaseExecutor {
	 ...
	 * @return
	 */
	public SingleResponse<UsageCountDefineVO> execute(@Valid CommonIdCommand deleteCommand) {
		...
		boolean delete = usageCountDefineGateway.delete(usageCountDefineId,deleteCommand);
		if (delete) {
