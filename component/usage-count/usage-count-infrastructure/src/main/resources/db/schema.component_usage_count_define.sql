-- 建表语句sql
DROP TABLE IF EXISTS component_usage_count_define;
CREATE TABLE `component_usage_count_define` (
  `id` bigint NOT NULL COMMENT 'id主键',
  `code` varchar(255) DEFAULT NULL COMMENT '编码，唯一,模糊查询',
  `name` varchar(100) NOT NULL COMMENT '名称,模糊查询',
  `url_pattern` varchar(300) DEFAULT NULL COMMENT '匹配的url地址，填写且能匹配后端限制',
  `is_group` tinyint(1) NOT NULL COMMENT '是否为分组，1=分组，0=配置',
  ...
  UNIQUE KEY `url_pattern` (`url_pattern`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='使用次数定义表';
