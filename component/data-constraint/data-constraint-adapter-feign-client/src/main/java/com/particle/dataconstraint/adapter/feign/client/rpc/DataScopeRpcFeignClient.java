 ...
 */
@FeignClient(name = "${particle.feign-client.dataconstraint.name:dataconstraint-start}", contextId = "dataScopeRpcFeignClient", url = "${particle.feign-client.dataconstraint.url:}", path = "/rpc/data_scope")
