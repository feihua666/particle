 ...
 */
@Tag(name = "数据范围自定义数据关系wap端后台管理相关接口")
@RestController
@RequestMapping("/admin/wap/data_scope_custom_data_rel")
public class DataScopeCustomDataRelAdminWapController extends AbstractBaseWapAdapter {
