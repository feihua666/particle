...
public class SsqCodeAdminWebController extends AbstractBaseWebAdapter {
	...
	@OpLog(name = "初始化全部双色球号码",module = OpLogConstants.Module.unknown,type = OpLogConstants.Type.create)
	...
	@OpLog(name = "更新全部双色球号码",module = OpLogConstants.Module.unknown,type = OpLogConstants.Type.update)
