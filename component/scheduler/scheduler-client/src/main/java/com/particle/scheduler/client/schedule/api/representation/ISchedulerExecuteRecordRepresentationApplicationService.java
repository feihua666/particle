...
public interface ISchedulerExecuteRecordRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<SchedulerExecuteRecordVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<SchedulerExecuteRecordVO> queryDetail(CommonIdCommand detailCommand);
