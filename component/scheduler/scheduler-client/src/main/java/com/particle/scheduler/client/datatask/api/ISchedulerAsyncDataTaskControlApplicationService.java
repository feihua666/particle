...
/**
 * <p>
 * 任务计划异步数据任务 控制应用门面服务类
 * </p>
 *
 * @author yw
 * @since 2025-05-22 22:38:42
 */
public interface ISchedulerAsyncDataTaskControlApplicationService extends IBaseApplicationService {
	/**
	 * 提交一个任务
	 ...
	 * @return 返回任务运行记录的id
	 */
	SchedulerAsyncDataTaskControlVO submit(String groupIdentifier, String uniqueIdentifier, String params, LocalDateTime dataExpireAt);
	 ...
	 * @param isHasError 是否有异常，如果有异常，异常的内容应该使用 {@link ISchedulerAsyncDataTaskControlApplicationService#log(String, Long, String)}记录
	 ...
	 * @return
	 */
	SchedulerAsyncDataTaskControlVO getControlVO(Long id, String uniqueIdentifier);
