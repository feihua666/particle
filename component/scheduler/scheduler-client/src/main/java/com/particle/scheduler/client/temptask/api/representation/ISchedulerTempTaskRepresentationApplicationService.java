...
public interface ISchedulerTempTaskRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<SchedulerTempTaskVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<SchedulerTempTaskVO> queryDetail(CommonIdCommand detailCommand);
