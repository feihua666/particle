...
public interface ISchedulerTempTaskRunRecordLogRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<SchedulerTempTaskRunRecordLogVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<SchedulerTempTaskRunRecordLogVO> queryDetail(CommonIdCommand detailCommand);
