...
public interface ISchedulerTempTaskRunRecordRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<SchedulerTempTaskRunRecordVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<SchedulerTempTaskRunRecordVO> queryDetail(CommonIdCommand detailCommand);
