...
import static com.particle.scheduler.client.dto.command.JobCronAddCommand.JOB_CLASS_TYPE_SCRIPT;
...
@Setter
@Getter
@Schema(description="更新任务表单对象")
public class JobCronUpdateCommand extends NameAndGroupCommand {
    ...
    @PropValid.DependCondition(message = "任务类全名不能为空",dependProp = "jobClassType",ifEqual = JobCronAddCommand.JOB_CLASS_TYPE_CUSTOM)
    @Schema(description = "任务类全名")
    private String jobClassName;

    @PropValid.DependCondition(message = "请求地址不能为空",dependProp = "jobClassType",ifEqual = JobCronAddCommand.JOB_CLASS_TYPE_HTTP)
    @Schema(description = "请求地址")
    private String httpUrl;

    @PropValid.DependCondition(message = "请求方法不能为空",dependProp = "jobClassType",ifEqual = JobCronAddCommand.JOB_CLASS_TYPE_HTTP)
    ...
    @PropValid.DependCondition(message = "bean名称不能为空",dependProp = "jobClassType",ifEqual = JobCronAddCommand.JOB_CLASS_TYPE_BEAN)
    @Schema(description = "bean名称")
    private String beanName;

    @PropValid.DependCondition(message = "bean方法名不能为空",dependProp = "jobClassType",ifEqual = JobCronAddCommand.JOB_CLASS_TYPE_BEAN)
