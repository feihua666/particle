...
public interface ISchedulerAsyncDataTaskRepresentationApplicationService extends IBaseApplicationService {
	 ...
	 * @return
	 */
	SingleResponse<SchedulerAsyncDataTaskVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand);
	 ...
	 * @return
	 */
	SingleResponse<SchedulerAsyncDataTaskVO> queryDetail(CommonIdCommand detailCommand);
