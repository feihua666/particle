-- 建表语句sql
DROP TABLE IF EXISTS component_scheduler_async_data_task;
CREATE TABLE `component_scheduler_async_data_task` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='任务计划异步任务数据表';
