...
public class SchedulerJobDataTaskAdminWebController extends AbstractBaseWebAdapter {
    ...
    public SingleResponse<SchedulerJobDataTaskVO> delete(@RequestBody CommonIdCommand deleteCommand){
    ...
    public SingleResponse<SchedulerJobDataTaskVO> queryDetailForUpdate(CommonIdCommand detailForUpdateCommand){
    ...
    @GetMapping("/detail")
    public SingleResponse<SchedulerJobDataTaskVO> queryDetail(CommonIdCommand detailCommand){
