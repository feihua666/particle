 ...
 */
@Tag(name = "任务计划临时任务运行记录日志移动端前台应用相关接口")
@RestController
@RequestMapping("/front/mobile/scheduler_temp_task_run_record_log")
public class SchedulerTempTaskRunRecordLogFrontMobileController extends AbstractBaseMobileAdapter {
