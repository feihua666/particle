...
let prefix = getApiPrefix(import.meta.env.VITE_API_PREFIX_DATA_QUERY) + '/admin/web/data_query_datasource_api'
/**
 * 添加数据查询数据源接口
 * @param data
 */
 ...
 * @param data
 */
const dataQueryDatasourceApiTestPrefix = prefix + '/test'
