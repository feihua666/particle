<script setup name="AdminComponentDependencyManageDeleteByComponentIdPage" lang="ts">
/**
 * 清空源组件源组件
 */
import {reactive ,ref} from 'vue'
import {deleteByComponentId} from "../../api/admin/adminComponentDependencyAdminApi"
...
const submitMethod = (form) => {
  return deleteByComponentId({id: form.componentId})
}
// 成功提示语
