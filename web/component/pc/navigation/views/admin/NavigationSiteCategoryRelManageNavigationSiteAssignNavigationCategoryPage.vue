<script setup name="NavigationSiteCategoryRelManageNavigationSiteAssignNavigationCategoryPage" lang="ts">
/**
 * 导航网站分配导航分类页面
 */
...
const formComps = ref(
    [
      ...
      {
        field: {
          name: 'checkedNavigationCategoryIds',
          value: []
        },
        element: {
          comp: 'PtTree',
          ...
          compProps: ({form})=> {
            return {
              ...
              dataInitMethod: ({param}) => {
                ...
                if(navigationSiteId){
                  return queryNavigationCategoryIdsByNavigationSiteId({id: navigationSiteId})
                }
                // 空函数不查询
                return {data: []}
              },
              ...
              // 可用数据列表
              dataMethod: navigationCategoryListApi,
...
// 提交按钮
const submitMethod = () => {
  return navigationSiteAssignNavigationCategoryApi
}
// 成功提示语
