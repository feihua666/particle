<script setup name="NavigationSiteCategoryRelManageAddPage" lang="ts">
/**
 * 导航网站分类关系管理添加页面
 */
...
const submitAttrs = ref({
  buttonText: '确认添加',
  permission: 'admin:web:navigationSiteCategoryRel:create',
})
// 提交按钮
const submitMethod = () => {
  return navigationSiteCategoryRelCreateApi
}
// 成功提示语
