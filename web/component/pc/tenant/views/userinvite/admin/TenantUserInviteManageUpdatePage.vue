<script setup name="TenantUserInviteManageUpdatePage" lang="ts">
/**
 * 租户用户邀请管理更新页面
 */
...
// 提交按钮
const submitMethod = () => {
  return TenantUserInviteUpdateApi
}
// 初始化加载更新的数据
const dataMethod = () => {
  return detailForUpdateApi({id: props.tenantUserInviteId})
}
// 成功提示语
