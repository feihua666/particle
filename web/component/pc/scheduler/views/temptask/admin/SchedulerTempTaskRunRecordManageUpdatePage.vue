<script setup name="SchedulerTempTaskRunRecordManageUpdatePage" lang="ts">
/**
 * 任务计划临时任务运行记录管理更新页面
 */
...
const reactiveData = reactive({
  // 表单
  form: {
    id: props.schedulerTempTaskRunRecordId,
    version: 1
  },
  // 表单数据对象
  formData: {},
...
// 提交按钮
const submitMethod = () => {
  return schedulerTempTaskRunRecordUpdateApi
}
// 初始化加载更新的数据
const dataMethod = () => {
  return detailForUpdateApi({id: props.schedulerTempTaskRunRecordId})
}
// 成功提示语
