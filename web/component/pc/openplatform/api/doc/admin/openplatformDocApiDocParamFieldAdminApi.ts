...
let prefix = getApiPrefix(import.meta.env.VITE_API_PREFIX_OPEN_PLATFORM) + '/admin/web/openplatform_doc_api_doc_param_field'
/**
 * 添加开放接口文档参数字段
 * @param data
 */
...
export const parseAndCreate = (data: anyObj): AxiosPromise => {
    return axios.post(prefix + '/parse-and-create',data)
}
/**
 * 删除开放接口文档参数字段
 * @param data
...
export const conditionRemove = (data: anyObj): AxiosPromise => {
    return axios.delete(prefix + '/conditionDelete',data)
}
/**
 * 删除开放接口文档参数字段
 * @param data
