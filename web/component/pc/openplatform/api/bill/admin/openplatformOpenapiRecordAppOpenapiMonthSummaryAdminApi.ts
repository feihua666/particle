...
let prefix = getApiPrefix(import.meta.env.VITE_API_PREFIX_OPEN_PLATFORM) + '/admin/web/openplatform_openapi_record_app_openapi_month_summary'
/**
 * 添加开放平台应用开放接口月汇总
 * @param data
 */
...
export const lastMonthStatistic = (data: anyObj): AxiosPromise => {
    return axios.post(prefix + '/lastMonthStatistic',data)
}
/**
 * 统计本月开放平台应用开放接口日汇总
 * @param data
...
export const thisMonthStatistic = (data: anyObj): AxiosPromise => {
    return axios.post(prefix + '/thisMonthStatistic',data)
}
