...
let prefix = getApiPrefix(import.meta.env.VITE_API_PREFIX_OPEN_PLATFORM) + '/admin/web/openplatform_openapi_record_app_openapi_day_summary'
/**
 * 添加开放平台应用开放接口日汇总
 * @param data
 */
...
export const yesterdayStatistic = (): AxiosPromise => {
    return axios.post(prefix + '/yesterdayStatistic')
}
/**
 * 统计今日开放平台应用开放接口日汇总
 * @param data
...
export const todayStatistic = (): AxiosPromise => {
    return axios.post(prefix + '/todayStatistic')
}
