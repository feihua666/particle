<script setup name="OpenplatformProviderRecordPrdApiDaySummaryManageAddPage" lang="ts">
/**
 * 开放平台供应商接口日汇总管理添加页面
 */
...
const submitAttrs = ref({
  buttonText: '确认添加',
  permission: 'admin:web:openplatformProviderRecordPrdApiDaySummary:create',
})
// 提交按钮
const submitMethod = () => {
  return openplatformProviderRecordPrdApiDaySummaryCreateApi
}
// 成功提示语
