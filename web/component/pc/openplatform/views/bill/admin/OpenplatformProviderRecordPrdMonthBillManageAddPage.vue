<script setup name="OpenplatformProviderRecordPrdMonthBillManageAddPage" lang="ts">
/**
 * 开放平台供应商月账单管理添加页面
 */
...
const submitAttrs = ref({
  buttonText: '确认添加',
  permission: 'admin:web:openplatformProviderRecordPrdMonthBill:create',
})
// 提交按钮
const submitMethod = () => {
  return openplatformProviderRecordPrdMonthBillCreateApi
}
// 成功提示语
