<script setup name="OpenplatformOpenapiRecordAppOpenapiDaySummaryManagePage" lang="ts">
/**
 * 开放平台应用开放接口日汇总管理页面
 */
...
const submitAttrs = ref({
  buttonText: '查询',
  loading: false,
  permission: 'admin:web:openplatformOpenapiRecordAppOpenapiDaySummary:pageQuery'
})
// 查询按钮
...
// 分页数据查询
const doOpenplatformOpenapiRecordAppOpenapiDaySummaryPageApi = ({pageQuery}: {param: object,pageQuery: {pageNo: number,pageSize: number}}) => {
  return openplatformOpenapiRecordAppOpenapiDaySummaryPageApi({...reactiveData.form,...pageQuery})
}
