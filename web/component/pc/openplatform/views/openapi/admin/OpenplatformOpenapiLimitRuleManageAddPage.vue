<script setup name="OpenplatformOpenapiLimitRuleManageAddPage" lang="ts">
/**
 * 开放平台开放接口限制规则管理添加页面
 */
...
const submitAttrs = ref({
  buttonText: '确认添加',
  permission: 'admin:web:openplatformOpenapiLimitRule:create',
})
// 提交按钮
const submitMethod = () => {
  return openplatformOpenapiLimitRuleCreateApi
}
// 成功提示语
