...
import openplatformDocApiDocResponseCodeAdminRoutes
    from './views/doc/admin/openplatformDocApiDocResponseCodeAdminRoutes'
...
import openplatformDocApiDocTemplateParamFieldAdminRoutes
    from "./views/doc/admin/openplatformDocApiDocTemplateParamFieldAdminRoutes";
import openplatformDocApiDocTemplateResponseCodeAdminRoutes
    from "./views/doc/admin/openplatformDocApiDocTemplateResponseCodeAdminRoutes";
import openplatformDocApiDocTemplateExampleCodeAdminRoutes
    from "./views/doc/admin/openplatformDocApiDocTemplateExampleCodeAdminRoutes";
