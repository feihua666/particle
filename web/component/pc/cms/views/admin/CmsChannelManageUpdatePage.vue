<script setup name="CmsChannelManageUpdatePage" lang="ts">
/**
 * 栏目管理更新页面
 */
import {reactive, ref} from 'vue'
import {
  update as cmsChannelUpdateApi,
...
// 提交按钮
const submitMethod = () => {
  return cmsChannelUpdateApi
}
// 初始化加载更新的数据
const dataMethod = () => {
  return detailForUpdateApi({id: props.cmsChannelId})
}
// 成功提示语
