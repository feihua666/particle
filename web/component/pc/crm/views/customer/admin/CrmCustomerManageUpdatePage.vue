<script setup name="CrmCustomerManageUpdatePage" lang="ts">
/**
 * 客户管理更新页面
 */
...
// 提交按钮
const submitMethod = () => {
  return crmCustomerUpdateApi
}
// 初始化加载更新的数据
const dataMethod = () => {
  return detailForUpdateApi({id: props.crmCustomerId})
}
// 成功提示语
