...
let prefix = getApiPrefix(import.meta.env.VITE_API_PREFIX_DATA) + '/admin/web/data_company_vc_financing_invest_institution_rel'
/**
 * 添加企业融资历史投资机构关系
 * @param data
 */
...
export const companyVcFinancingAssignCompanyVcInvestInstitution = (data: CompanyVcFinancingAssignCompanyVcInvestInstitution): AxiosPromise => {
    return axios.post(prefix + '/companyVcFinancing/assign/companyVcInvestInstitution',data)
}
/**
...
export const queryCompanyVcInvestInstitutionIdsByCompanyVcFinancingId = (data: IdParam): AxiosPromise => {
    return axios.get(prefix + '/queryCompanyVcInvestInstitutionIdsByCompanyVcFinancingId',{params: data})
}
/**
...
export const deleteByCompanyVcFinancingId = (data: IdParam): AxiosPromise => {
    return axios.delete(prefix + '/deleteByCompanyVcFinancingId',{data: data})
}
...
export const companyVcInvestInstitutionAssignCompanyVcFinancing = (data: CompanyVcInvestInstitutionAssignCompanyVcFinancing): AxiosPromise => {
    return axios.post(prefix + '/companyVcInvestInstitution/assign/companyVcFinancing',data)
}
/**
...
export const queryCompanyVcFinancingIdsByCompanyVcInvestInstitutionId = (data: IdParam): AxiosPromise => {
    return axios.get(prefix + '/queryCompanyVcFinancingIdsByCompanyVcInvestInstitutionId',{params: data})
}
/**
...
export const deleteByCompanyVcInvestInstitutionId = (data: IdParam): AxiosPromise => {
    return axios.delete(prefix + '/deleteByCompanyVcInvestInstitutionId',{data: data})
}
