...
let prefix = getApiPrefix(import.meta.env.VITE_API_PREFIX_DATA) + '/admin/web/dynamic_data_indicator'
/**
 * 添加动态数据指标
 * @param data
 */
...
export const listWithDynamicTableField = (data: anyObj): AxiosPromise => {
    return axios.get(prefix + '/listWithDynamicTableField',{params: data})
}
/**
 * 列表，分页
 * @param data
