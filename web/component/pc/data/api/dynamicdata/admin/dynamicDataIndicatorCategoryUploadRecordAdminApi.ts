...
let prefix = getApiPrefix(import.meta.env.VITE_API_PREFIX_DATA) + '/admin/web/dynamic_data_indicator_category_upload_record'
/**
 * 添加动态数据指标分类上传记录
 * @param data
 */
...
export const publish = (data: IdParam): AxiosPromise => {
    return axios.put(prefix + '/publish',data)
}
