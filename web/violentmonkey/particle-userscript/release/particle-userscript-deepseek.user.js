...
// @license      MIT
// @icon         data:image/png;base64,
...
(function (vue, Varlet) {
  ...
  const d$1=new Set;const n = async e=>{d$1.has(e)||(d$1.add(e),(t=>{typeof GM_addStyle=="function"?GM_addStyle(t):(document.head||document.documentElement).appendChild(document.createElement("style")).append(t);})(e));};

  n(" .no-drag[data-v-9041758b]{pointer-events:none} ");
  ...
  const deepseekLogo = "data:image/png;base64,";
...
list: {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_var_paper, {
              ...
              default: vue.withCtx(() => [
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.list, (item, index) => {
                  return vue.openBlock(), vue.createBlock(_component_var_cell, {
                    ripple: "",
                    key: item.id,
                    border: index !== __props.list.length - 1,
                    "border-offset": 0,
...
clientX: rect.left + rect.width / 2,
  ...
  const _sfc_main$3 = vue.defineComponent({
    __name: "BatchDeleteConversationDialog",
    props: {
      show: Boolean
    },
    emits: ["update:show"],
    setup(__props, { emit: __emit }) {
      ...
      async function removeSelected() {
        ...
        for (const item of targets) {
          try {
            await delayChain(item).step((target) => {
              const wrapper = target.el.querySelectorAll(":scope > div")[2];
        ...
        list.value = list.value.filter((x2) => !selected.value.includes(x2.id));
        selected.value = [];
      }
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_var_popup, {
          ...
          "onUpdate:show": _cache[1] || (_cache[1] = ($event) => computedShow.value = $event),
          position: "right",
          "lock-scroll": false,
          style: { "display": "flex", "flex-direction": "column" }
        }, {
          default: vue.withCtx(() => [
            vue.createVNode(_component_var_app_bar, { title: "会话批量删除" }),
  ...
  const getTransaction = (db, storeName, mode = "readonly") => {
    return db.transaction(storeName, mode);
  };
  const getStore = (transaction, storeName) => {
    return transaction.objectStore(storeName);
  };
  const findFirst = (store, predicate) => {
...
Please report this to https://github.com/markedjs/marked.`, e) {
  ...
  b.parse;
  x.lex;
  const DB_NAME$1 = "deepseek-chat";
  const STORE_NAME$1 = "history-message";
  const templateRoot = `
...
`;
  const _sfc_main$2 = vue.defineComponent({
    __name: "DownloadConversationToHtml",
    setup(__props, { expose: __expose }) {
      ...
      const getConversationFromDB = async (sessionId) => {
        const db = await openDB(DB_NAME$1);
        try {
          const transaction = getTransaction(db, STORE_NAME$1);
          const store = getStore(transaction, STORE_NAME$1);
...
gfm: true
  ...
  const _sfc_main$1 = vue.defineComponent({
    __name: "DownloadConversationToMd",
    setup(__props, { expose: __expose }) {
      const $alert = (message, type = "info") => {
        Varlet.Snackbar[type] ? Varlet.Snackbar[type](message) : Varlet.Snackbar(message);
      };
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
          vue.createVNode(_component_var_fab, {
            ...
            default: vue.withCtx(() => [
              vue.createVNode(_component_var_tooltip, {
                ...
                default: vue.withCtx(() => [
                  vue.createVNode(_component_var_button, {
                    onClick: _cache[0] || (_cache[0] = ($event) => batchDeleteDialogshow.value = !batchDeleteDialogshow.value),
                    "icon-container": ""
                  }, {
                    default: vue.withCtx(() => [
                      vue.createVNode(_component_var_icon, { name: "delete" })
                    ]),
                    _: 1
                  })
                ]),
              ...
              vue.createVNode(_component_var_tooltip, {
                ...
                default: vue.withCtx(() => [
                  vue.createVNode(_component_var_button, {
                    onClick: _cache[1] || (_cache[1] = ($event) => downloadConversionToHtml.value?.exportFile()),
                    "icon-container": ""
                  }, {
                    default: vue.withCtx(() => [
                      vue.createVNode(_component_var_icon, { name: "arrow-down" })
                    ]),
                    _: 1
                  })
                ]),
              ...
              vue.createVNode(_component_var_tooltip, {
                ...
                default: vue.withCtx(() => [
                  vue.createVNode(_component_var_button, {
                    onClick: _cache[2] || (_cache[2] = ($event) => downloadConversionToMd.value?.exportFile()),
                    "icon-container": ""
                  }, {
                    default: vue.withCtx(() => [
                      vue.createVNode(_component_var_icon, { name: "arrow-down" })
          ...
          vue.createVNode(_sfc_main$3, {
            show: batchDeleteDialogshow.value,
            "onUpdate:show": _cache[3] || (_cache[3] = ($event) => batchDeleteDialogshow.value = $event)
          }, null, 8, ["show"]),
          vue.createVNode(_sfc_main$2, {
            ref_key: "downloadConversionToHtml",
            ref: downloadConversionToHtml
          }, null, 512),
          vue.createVNode(_sfc_main$1, {
            ref_key: "downloadConversionToMd",
            ref: downloadConversionToMd
          }, null, 512)
        ], 64);
      };
    }
  };
  const App = _export_sfc(_sfc_main, [["__scopeId", "data-v-9041758b"]]);
