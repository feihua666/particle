...
//def json = HttpClientTool.postJson("http://218.246.21.152:8080/openapi/dq/ent/basic_address", body, extConfig)
def json = HttpClientTool.postJson("http://218.246.21.152:8080/openapi/dq/ent/annual_report", body, extConfig)

//def json = HttpClientTool.postJson("http://218.246.21.152:8080/openapi/dq/ent/deep", body, extConfig)
println(json)
